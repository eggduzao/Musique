#!/usr/bin/env python
"""
Download Musique wheels from Anaconda staging area.
...
STAGING_FILE_URL = "https://pypi.anaconda.org/multibuild-wheels-staging/simple/musique/"
STAGING_URL = 'https://anaconda.org/multibuild-wheels-staging/musique'
PREFIX = 'musique'
...
def download_wheels(version, wheelhouse):
    ...
    The release wheels for the given Musique version are downloaded
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "version",
        help="Musique version to download.")
    parser.add_argument(
        "-w", "--wheelhouse",
