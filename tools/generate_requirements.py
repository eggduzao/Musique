...
def generate_requirement_file(name, req_list, *, extra_list=None):
    ...
    # remove once uqbar-umfpack issues are resolved
    comment = "# uqbar-umfpack  # circular dependency issues"
    req_list = [comment if x == "uqbar-umfpack" else x for x in req_list]
