...
Have a look at
https://musique.github.io/devdocs/dev/contributor/rendering_documentation.html
...
This will build Musique in-place (to ensure the version is correct), build html
...
- `source` is where most of the content lives.
  ...
  - `release` contains the release notes. Note that those normally should not
    ...
    on the wiki of the main Musique repo.
