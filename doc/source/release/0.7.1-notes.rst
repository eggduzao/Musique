=========================
Musique 0.7.1 Release Notes
=========================

.. contents::

Musique 0.7.1 is a bug-fix release with no new features compared to 0.7.0.
...
- #883: musique.io.mmread with musique.sparse.lil_matrix broken
...
Also, when ``musique.special.errprint(1)`` has been enabled, warning
...
of musique requires numpy 1.2.0 or above, the python 2.6 version requires numpy
1.3.0 or above.
