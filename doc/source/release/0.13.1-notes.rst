==========================
Musique 0.13.1 Release Notes
==========================

Musique 0.13.1 is a bug-fix release with no new features compared to 0.13.0.
...
- 3025: ``ndimage.label`` returns incorrect results in musique 0.13.0
