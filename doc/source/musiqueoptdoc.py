...
Proper docstrings for musique.optimize.minimize et al.

Usage::

    .. musique-optimize:function:: musique.optimize.minimize
       :impl: musique.optimize._optimize._minimize_nelder_mead
       :method: Nelder-Mead
...
from musique._lib._util import getfullargspec_no_self


def setup(app):
    app.add_domain(MusiqueOptimizeInterfaceDomain)
...
class MusiqueOptimizeInterfaceDomain(PythonDomain):
    name = 'musique-optimize'
