...
========================
Musique Project Governance
========================

The purpose of this document is to formalize the governance process
used by the Musique project in both ordinary and extraordinary
...
The Musique Project (The Project) is an open source software project.
The goal of The Project is to develop open source software for scientific
computing in Python, and, in particular, the ``musique`` package. The Software
...
the ``musique`` GitHub organization.
...
a more formal governance model. The Musique Core Developers expressed a
...
page `About us <https://musique.org/about/>`_.
...
- Starting a review of the technical direction of the project (as captured by
  the :ref:`musique-roadmap`) bi-yearly, around mid-April and mid-October.
...
override the Steering Council. If a Partner has funding to do Musique work
...
that part of the Partner’s work will not be under the Musique umbrella and
cannot use the Project trademarks in any way that suggests a formal
relationship.

Institutional Partner benefits are:

-  acknowledgement on the Musique website and in talks
-  ability to acknowledge their own funding sources on the Musique
   website and in talks
-  ability to influence the project through the participation of their
   Council Member
-  invitation of the Council Members to Musique Developer Meetings

A list of current Institutional Partners is maintained at the page
`About us <https://musique.org/about/>`_.


Document history
================

https://github.com/musique/musique/commits/main/doc/source/dev/governance/governance.rst
...
copyright and related or neighboring rights to the Musique project
