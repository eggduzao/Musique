...
This updates your feature branch with changes from the upstream `Musique
...
First fork Musique into your account, as from :ref:`forking`.

Then, go to your forked repository GitHub page, say
``https://github.com/your-user-name/musique``
...
Now all those people can do::
    ...
    git clone git@github.com:your-user-name/musique.git
...
`musique/main`_ back to stable release branches. To do this you make a branch
off the branch you are backporting to, cherry pick the commits you want from
``musique/main``, and then submit a pull request for the branch containing the
backport.

1. First, you need to make the branch you will work on. This needs to be
   based on the older version of Musique (not main)::

    # Make a new branch based on musique/maintenance/1.8.x,
...
*This is only relevant if you have commit rights to the main Musique repo.*

When you have a set of "ready" changes in a feature branch ready for
Musique's ``main`` or ``maintenance`` branches, you can push
...
.. _musique/main: https://github.com/musique/musique
