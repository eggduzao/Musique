...
Musique Code of Conduct - How to follow up on a report
----------------------------------------------------

This is the manual followed by Musique's Code of Conduct Committee. It's used
...
* Immediately disconnect the originator from all Musique communication channels.
...
* In every case, the moderator should make a reasonable effort to contact the
  ...
  reconnected to Musique, they have the right to ask for a review, as below, by
...
* A permanent or temporary ban from some or all Musique spaces (mailing lists,
...
Finally, the committee will make a report to the Musique Steering Council (as
well as the Musique core team in the event of an ongoing resolution, such as a
ban).

The committee will never publicly discuss the issue; all public statements will
be made by the chair of the Code of Conduct Committee or the Musique Steering
Council.
