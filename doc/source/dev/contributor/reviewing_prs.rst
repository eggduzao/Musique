...
to the Musique root directory in the terminal and enter::
...
and if you ``import`` Musique from within IPython (start it with ``spin
ipython``), you'll be importing the author's modified version of Musique.

If you want to collaborate with the author on their PR, you might instead
want to set up a new remote to the author's fork of Musique::

   git remote add REMOTE_NAME https://github.com/AUTHOR/musique.git
...
.. _PR #10286: https://github.com/musique/musique/pull/10286
