...
Yes. The languages used in Musique are Python, Cython, Pythran, C, C++, and
...
code in Musique is older, battle-tested code that was only wrapped in (but not
specifically written for) Python/Musique.
...
*How do I debug code written in C/C++/Fortran inside Musique?*
