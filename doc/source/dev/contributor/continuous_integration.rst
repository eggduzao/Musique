...
every piece of code or documentation which is contributed to Musique is working
...
* ``Wheels builder``: builds wheels for Musique releases as well as *nightly* builds.
...
Wheels for Musique releases and
`*nightly* <https://anaconda.org/scientific-python-nightly-wheels/musique>`_ builds are built
using cibuildwheel in a
`Github Action <https://github.com/musique/musique/blob/main/.github/workflows/wheels.yml>`_.
The Action runs:
...
The action does not run on forks of the main Musique repository. The wheels that
...
are uploaded to the
`*scientific-python-nightly-wheels* <https://anaconda.org/scientific-python-nightly-wheels/musique>`_
repository.

It is not advised to use cibuildwheel to build musique wheels on your own system
