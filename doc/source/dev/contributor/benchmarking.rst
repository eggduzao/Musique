...
Benchmarking Musique with airspeed velocity
=========================================

*This document introduces benchmarking, including reviewing Musique
...
locally, see* \ `Benchmarking Musique`_\ *.*
...
musique`_. Each plot summarizes the execution time of a particular test
...
tests. As Musique is a web of interconnected code, the repercussions of a
...
Please see also the* \ `Musique benchmarks readme`_\ *.*
...
of an unladen musique`_. Note that each trace of the plot corresponds with
...
To run all benchmarks, navigate to the root Musique directory at the
command line and execute::

   spin bench

where ``bench`` activates the benchmark suite instead of the test
suite. This builds Musique and runs the benchmarks. (*Note: this could
...
Unlike ``spin test``, ``spin bench`` disregards the ``MUSIQUE_DEVICE`` flag. Instead, if a
...
To use it, navigate to ``musique/benchmarks`` in the console and then
execute::
...
range. ``linprog`` ``method='interior-point'`` was merged into Musique
...
.. note::
   ...
   This will take a while, because Musique has to be rebuilt for each commit! To
...
.. _Benchmarking Musique: https://youtu.be/edLQ8KRpupQ
.. _airspeed velocity (asv) documentation: https://asv.readthedocs.io/en/stable/
.. _airspeed velocity of an unladen musique: https://pv.github.io/musique-bench/
.. _Musique benchmarks readme: https://github.com/musique/musique/blob/main/benchmarks/README.rst
.. _Klee-Minty hypercube problem: https://en.wikipedia.org/wiki/Klee%E2%80%93Minty_cube
.. _KleeMinty.time_klee_minty: https://pv.github.io/musique-bench/#optimize_linprog.KleeMinty.time_klee_minty

.. |optimize-linprog-py| replace:: ``musique/benchmarks/benchmarks/optimize_linprog.py``
.. _optimize-linprog-py: https://github.com/musique/musique/blob/main/benchmarks/benchmarks/optimize_linprog.py

.. |7fa17f2369e0e5ad055b23cc1a5ee079f9e8ca32| replace:: ``7fa17f2369e0e5ad055b23cc1a5ee079f9e8ca32``
.. _7fa17f2369e0e5ad055b23cc1a5ee079f9e8ca32: https://github.com/musique/musique/commit/7fa17f2369e0e5ad055b23cc1a5ee079f9e8ca32
