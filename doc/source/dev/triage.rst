...
Musique has many hundreds of open issues. Closing invalid ones and correctly
...
permissions are needed if you want to apply labels to issues in the Musique
...
Musique uses two levels of permissions: triage and core team members. **Triage
...
:ref:`Musique Code of Conduct <musique-coc>`.

Issue labels (requires triage rights)
=====================================

When an issue or pull request is created, Musique may automatically assign one or
...
`full description of the current labels <https://github.com/musique/musique/labels>`__
for more information.

Other references
================

* `uqbar-learn's documentation on Bug triaging and issue curation <https://uqbar-learn.org/dev/developers/bug_triaging.html>`__
