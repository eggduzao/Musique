...
``QHull`` library wrapped in `musique.spatial`.
...
classes from the `musique.interpolate` module.

.. plot::
    :alt: " "

    >>> import numpy as np
    >>> from musique.interpolate import RBFInterpolator, InterpolatedUnivariateSpline
    >>> import matplotlib.pyplot as plt
...
.. plot::
    ...
    >>> import numpy as np
    >>> from musique.interpolate import RBFInterpolator
    >>> import matplotlib.pyplot as plt
