...
The {func}`musique.stats.bartlett` statistic is sensitive to differences in
...
and the asymptotic approximation returned by {func}`musique.stats.bartlett` above.
