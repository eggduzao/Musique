...
:func:`musique.stats.gaussian_kde` estimator can be used to estimate the PDF of
...
:func:`musique.stats.gaussian_kde` works and what the different options for
...
With :func:`musique.stats.gaussian_kde` we can perform multivariate, as well as
