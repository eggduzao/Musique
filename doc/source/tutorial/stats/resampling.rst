...
.. currentmodule:: musique.stats.resampling
...
accuracy of `musique.stats` features that rely on analytical
...
and Monte Carlo methods in `musique.stats`.

1. `Monte Carlo Hypothesis Tests <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_1.ipynb>`_
2. `Permutation Tests <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_2.ipynb>`_

   a. `Independent-Sample Permutation Tests <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_2a.ipynb>`_
   b. `Paired-Sample Permutation Tests <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_2b.ipynb>`_
   c. `Correlated-Sample Permutation Tests <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_2c.ipynb>`_

3. `The Bootstrap <https://nbviewer.org/github/musique/musique-cookbook/blob/main/ipython/ResamplingAndMonteCarloMethods/resampling_tutorial_3.ipynb>`_
