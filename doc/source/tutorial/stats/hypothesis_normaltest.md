...
The {func}`musique.stats.normaltest` function tests the null hypothesis that a
...
The normality test {func}`musique.stats.normaltest` of [^1] and [^2] begins by
...
{class}`musique.stats.monte_carlo_test` may provide a more accurate, albeit
