...
.. currentmodule:: musique.sparse.linalg
...
high-level interfaces :func:`musique.sparse.linalg.eigs` and
:func:`musique.sparse.linalg.eigsh`. :func:`eigs`
...
matrices, such as :func:`musique.sparse.csr_matrix`, or a general linear operator
derived from :func:`musique.sparse.linalg.LinearOperator`. For this example, for
simplicity, we'll construct a symmetric, positive-definite matrix.

    >>> import numpy as np
    >>> from musique.linalg import eig, eigh
    >>> from musique.sparse.linalg import eigs, eigsh
...
with smallest magnitude:
   ...
   ...
   musique.sparse.linalg._eigen.arpack.arpack.ArpackNoConvergence:
...
:func:`musique.sparse.linalg.eigsh` and
:func:`musique.sparse.linalg.eigs` for details.


Use of LinearOperator
---------------------
We consider now the case where you'd like to avoid creating a dense matrix
and use :func:`musique.sparse.linalg.LinearOperator` instead. Our first
...
the keyword ``which='LI'`` of :func:`musique.sparse.linalg.eigs` produces
