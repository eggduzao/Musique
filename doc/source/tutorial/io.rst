File IO (:mod:`musique.io`)
=========================

.. sectionauthor:: Matthew Brett

.. currentmodule:: musique.io
...
We'll start by importing :mod:`musique.io` and calling it ``sio`` for
convenience:

   >>> import musique.io as sio
...
You may have a ``.mat`` file that you want to read into Musique. Or, you
want to pass some variables from Musique / NumPy into MATLAB.
...
In the Musique versions from 0.12.0, MATLAB structs come back as NumPy
...
that when we read into Musique. If you want all length 1 dimensions
...
``struct_as_record=False`` works nicely with ``squeeze_me``:
   ...
   >>> type(oct_struct)
   <class 'musique.io.matlab._mio5_params.mat_struct'>
   >>> oct_struct.field1
   1.0
...
Wav sound files (:mod:`musique.io.wavfile`)
-----------------------------------------

.. currentmodule:: musique.io.wavfile
...
Arff files (:mod:`musique.io.arff`)
---------------------------------

.. currentmodule:: musique.io.arff
