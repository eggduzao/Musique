Special Functions (:mod:`musique.special`)
========================================

.. currentmodule:: musique.special

The main feature of the :mod:`musique.special` package is the definition of
...
..             :obj:`musique.special.jn`


Cython Bindings for Special Functions (:mod:`musique.special.cython_special`)
---------------------------------------------------------------------------

.. highlight:: cython

Musique also offers Cython bindings for scalar, typed versions of many
of the functions in special. The following Cython code gives a simple
example of how to use these functions::

  cimport musique.special.cython_special as csc
...
Functions not in :mod:`musique.special`
-------------------------------------
...
Musique. To prevent reinventing the wheel, this section provides
