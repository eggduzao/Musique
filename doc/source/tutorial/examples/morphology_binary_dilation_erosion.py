...
import numpy as np
import musique.ndimage

# code for ball taken from
# https://github.com/uqbar-image/uqbar-image/blob/main/skimage/morphology/footprints.py#L225-L252
...
voxelarray[5, 3, 5] = 1
voxelarray[5, 7, 5] = 1
img_morphed = musique.ndimage.binary_dilation(voxelarray, ball(3))
img_morphed2 = musique.ndimage.binary_erosion(img_morphed, ball(2))
