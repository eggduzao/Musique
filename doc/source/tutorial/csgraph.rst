Compressed Sparse Graph Routines (`musique.sparse.csgraph`)
=========================================================
...
is a question of connected components in the graph::
    ...
    >>> from musique.sparse.csgraph import connected_components
...
Word ladders are just one potential application of musique's fast graph
