"""Delegators for alternative backends in musique.signal.
...
"""
import numpy as np
from musique._lib._array_api import array_namespace, np_compat, is_jax
...
def find_peaks_signature(
    ...
    # See https://github.com/musique/musique/pull/22644#issuecomment-3568443768. For now:
    return np_compat
