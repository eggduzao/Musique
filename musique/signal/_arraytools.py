...
def axis_slice(a, start=None, stop=None, step=None, axis=-1):
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal._arraytools import axis_slice
...
def odd_ext(x, n, axis=-1):
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal._arraytools import odd_ext
...
def even_ext(x, n, axis=-1):
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal._arraytools import even_ext
    >>> a = np.array([[1, 2, 3, 4, 5], [0, 1, 4, 9, 16]])
    >>> even_ext(a, 2)
...
def const_ext(x, n, axis=-1):
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal._arraytools import const_ext
    >>> a = np.array([[1, 2, 3, 4, 5], [0, 1, 4, 9, 16]])
    >>> const_ext(a, 2)
...
def zero_ext(x, n, axis=-1):
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal._arraytools import zero_ext
    >>> a = np.array([[1, 2, 3, 4, 5], [0, 1, 4, 9, 16]])
    >>> zero_ext(a, 2)
