...
from musique._lib.deprecation import _deprecate_positional_args, _NoValue
...
def lombscargle(
    ...
    *,
    ...
    precenter : bool, optional
        ...
        .. deprecated:: 1.17.0
            The `precenter` argument is deprecated and will be removed in Musique 1.19.0.
    ...
    >>> from musique.signal import lombscargle
    ...
    if precenter is not _NoValue:
        msg = ("Use of parameter 'precenter' is deprecated as of Musique 1.17.0 and "
...
def csd(x, y, fs=1.0, window='hann_periodic', nperseg=None, noverlap=None, nfft=None,
    ...
    * `ShortTimeFFT` uses `float64` / `complex128` internally, which is due to the
      behavior of the utilized `~musique.fft` module. Thus, those are the dtypes being
...
def check_COLA(window, nperseg, noverlap, tol=1e-10):
    ...
    .. legacy:: function
        ...
        >>> import numpy as np
        >>> from musique.signal import check_COLA, closest_STFT_dual_window, windows
        ...
...
def _spectral_helper(x, y, fs=1.0, window='hann', nperseg=None, noverlap=None,
    ...
    .. legacy:: function
        ...
        (which are also in this same source file `musique/signal/_spectral_py.py`).
...
def _fft_helper(x, win, detrend_func, nperseg, noverlap, nfft, sides):
    ...
    `musique.signal._spectral_helper`.
