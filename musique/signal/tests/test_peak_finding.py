...
from musique.signal._peak_finding import (
    argrelmax,
    argrelmin,
    peak_prominences,
    peak_widths,
...
from musique.signal._peak_finding_utils import _local_maxima_1d, PeakPropertyWarning
...
def test_unpack_condition_args():
    """
    Verify parsing of condition arguments for `musique.signal.find_peaks` function.
    """
    x = np.arange(10)
    amin_true = x
