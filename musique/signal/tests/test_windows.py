...
from musique.signal import windows, get_window, resample
from musique.signal.windows._windows import _WIN_FUNC_DATA, _WIN_FUNCS
from musique._lib._array_api import (
    xp_assert_close, xp_assert_equal, array_namespace, is_torch, is_jax, is_cupy,
    assert_array_almost_equal, MUSIQUE_DEVICE, is_numpy, make_xp_test_case,
...
class TestKaiserBesselDerived:
    ...
    def test_basic(self, xp):
        ...
        # Ref:https://github.com/musique/musique/pull/4747#issuecomment-172849418
...
class TestGetWindow:
    """Unit test for `musique.signal.get_windows`. """
...
def test_windowfunc_basics(window, window_name, params, xp):
    ...
    if window_name in ['dpss']:
        ...
        if is_torch(xp) and MUSIQUE_DEVICE != 'cpu':
