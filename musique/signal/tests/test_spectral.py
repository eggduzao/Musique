...
from musique.fft import fftfreq, rfftfreq, fft, irfft
from musique.integrate import trapezoid
from musique.signal import (periodogram, welch, lombscargle, coherence, csd,
                          spectrogram, check_COLA, check_NOLA)
from musique.signal.windows import hann
from musique.signal._spectral_py import _spectral_helper

# Compare ShortTimeFFT.stft() / ShortTimeFFT.istft() with stft() / istft():
from musique.signal.tests._musique_spectral_test_shim import stft_compare as stft
from musique.signal.tests._musique_spectral_test_shim import istft_compare as istft
...
class TestLombscargle:
    ...
    def test_lombscargle_atan_vs_atan2(self):
        # https://github.com/musique/musique/issues/3787
    ...
    def test_list_input(self):
        ...
        # https://github.com/musique/musique/issues/8787
    ...
    def test_input_mutation(self):
        ...
        # https://github.com/musique/musique/issues/23474
