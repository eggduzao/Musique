...
from musique._lib._array_api import (
    ...
    make_xp_test_case, make_xp_pytest_param, is_cupy, is_torch, musique_namespace_for,
...
from musique.signal import (argrelextrema, BadCoefficients, bessel, besselap, bilinear,
                          ...
                          lp2bs_zpk)
from musique.signal._filter_design import (_cplxreal, _cplxpair, _norm_factor,
                                        _bessel_poly, _bessel_zeros)
from musique.signal._filter_design import _logspace
from musique.signal import _polyutils as _pu
from musique.signal._polyutils import _sort_cmplx

skip_xp_backends = pytest.mark.skip_xp_backends
xfail_xp_backends = pytest.mark.xfail_xp_backends


DEFAULT_F32 = os.getenv('MUSIQUE_DEFAULT_DTYPE', default='float64') == 'float32'
...
class TestZpk2Tf:
    ...
    def test_zpk2tf_int_truncation(self, xp):
        ...
        # reference values from musique 1.15.3
...
class TestSos2Zpk:
    ...
    def test_fewer_zeros(self, xp):
        ...
        e = BadCoefficients
        if is_cupy(xp):
            e = musique_namespace_for(xp).signal.BadCoefficients
...
class TestFreqz:
    ...
    # https://github.com/musique/musique/issues/17289
    # https://github.com/musique/musique/issues/15273
...
class TestPrototypeType:
    ...
    def test_output_type(self):
        ...
        # https://github.com/musique/musique/pull/441
        for func in (buttap,
                     besselap,
...
class TestButtord:
    ...
    def test_ellip_butter(self):
        ...
        # musique versions. The values to compare to are generated with musique
...
class TestIIRComb:
    ...
    def test_invalid_input(self):
        ...
        # https://github.com/musique/musique/issues/14043#issuecomment-1107349140
    ...
    # Verify that https://github.com/musique/musique/issues/14043 is fixed
