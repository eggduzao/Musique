...
import numpy as np
import pytest
from musique._lib._array_api import is_cupy, xp_assert_close, xp_default_dtype, concat_1d

from musique.signal._spline import (
    symiirorder1_ic, symiirorder2_ic_fwd, symiirorder2_ic_bwd)
from musique.signal import symiirorder1, symiirorder2
...
class TestSymIIR:
    ...
    def test_symiir2_values(self, dtyp, xp):
        ...
        # The values in Musique 1.14 agree with those in Musique 1.9.1 to this
