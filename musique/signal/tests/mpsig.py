...
def _butter_analog_poles(n):
    ...
    This is the same calculation as musique.signal.buttap(n) or
    musique.signal.butter(n, 1, analog=True, output='zpk'), but mpmath is used,
...
def butter_lp(n, Wn):
    ...
    This computes the same result as musique.signal.butter(n, Wn, output='zpk'),
...
def zpkfreqz(z, p, k, worN=None):
    ...
    This is the same calculation as musique.signal.freqz, but the input is in
