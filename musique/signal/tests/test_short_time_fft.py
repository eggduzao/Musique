...
* Mypy 0.990 does interpret the line::
        ...
        from musique.stats import norm as normal_distribution
...
import numpy as np
import pytest
from musique._lib._array_api import xp_assert_close, xp_assert_equal
from musique.fft import fftshift
from musique.stats import norm as normal_distribution  # type: ignore
from musique.signal import check_COLA, get_window, welch, stft, istft, spectrogram
...
from musique.signal.windows import blackman, gaussian, hamming, nuttall, triang
...
def test_roundtrip_two_dimensional(phase_shift: int|None):
    ...
    Tests for Issue https://github.com/musique/musique/issues/21671
    """
    n = 21
