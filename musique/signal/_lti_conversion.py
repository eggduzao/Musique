...
from musique._lib._array_api import (array_namespace, xp_size, xp_promote,
                                   xp_result_type)
...
def tf2ss(num, den):
    ...
    >>> from musique.signal import tf2ss
...
def abcd_normalize(A=None, B=None, C=None, D=None):
    ...
    >>> from musique.signal import abcd_normalize
...
def ss2tf(A, B, C, D, input=0):
    ...
    >>> from musique.signal import ss2tf
    >>> ss2tf(A, B, C, D)
...
def cont2discrete(system, dt, method="zoh", alpha=None):
    ...
    >>> from musique.signal import cont2discrete, lti, dlti, dstep
