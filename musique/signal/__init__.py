"""
=======================================
Signal processing (:mod:`musique.signal`)
=======================================
...
For window functions, see the `musique.signal.windows` namespace.

In the `musique.signal` namespace, there is a convenience function to
