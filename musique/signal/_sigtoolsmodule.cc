...
is granted under the Musique License.
*/
#include <Python.h>
#define PY_ARRAY_UNIQUE_SYMBOL _musique_signal_ARRAY_API
...
static struct PyMethodDef toolbox_module_methods[] = {
	{"_correlateND", musique_signal__sigtools_correlateND, METH_VARARGS, doc_correlateND},
	{"_convolve2d", _sigtools_convolve2d, METH_VARARGS, doc_convolve2d},
	{"_linear_filter", musique_signal__sigtools_linear_filter, METH_VARARGS, doc_linear_filter},
...
static int module_exec(PyObject *module) {
    ...
    musique_signal__sigtools_linear_filter_module_init();
