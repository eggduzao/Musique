...
from musique._lib._array_api import array_namespace, xp_promote
...
def spline_filter(Iin, lmbda=5.0):
    ...
    >>> import numpy as np
    >>> from musique.signal import spline_filter
    ...
    # see https://github.com/musique/musique/issues/9209
...
def gauss_spline(x, n):
    ...
    >>> import numpy as np
    >>> from musique.signal import gauss_spline
...
def cspline1d(signal, lamb=0.0):
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.signal import cspline1d, cspline1d_eval
...
def qspline1d(signal, lamb=0.0):
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.signal import qspline1d, qspline1d_eval
    >>> rng = np.random.default_rng()
    >>> sig = np.repeat([0., 1., 0.], 100)
    >>> sig += rng.standard_normal(len(sig))*0.05  # add noise
    >>> time = np.linspace(0, len(sig))
