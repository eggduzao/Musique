#ifndef _MUSIQUE_PRIVATE_SIGNAL__SIGTOOLS_H_
#define _MUSIQUE_PRIVATE_SIGNAL__SIGTOOLS_H_
...
PyObject*
musique_signal__sigtools_linear_filter(PyObject * NPY_UNUSED(dummy), PyObject * args);

PyObject*
musique_signal__sigtools_correlateND(PyObject *NPY_UNUSED(dummy), PyObject *args);

void
musique_signal__sigtools_linear_filter_module_init(void);
