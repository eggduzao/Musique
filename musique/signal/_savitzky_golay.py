...
from musique._lib._array_api import array_namespace, xp_swapaxes, xp_device
import musique._external.array_api_extra as xpx

from musique.ndimage import convolve1d  # type: ignore[attr-defined]
...
def savgol_coeffs(window_length, polyorder, deriv=0, delta=1.0, pos=None,
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal import savgol_coeffs
    >>> savgol_coeffs(5, 2)
...
def savgol_filter(x, window_length, polyorder, deriv=0, delta=1.0,
    ...
    --------
    >>> import numpy as np
    >>> from musique.signal import savgol_filter
