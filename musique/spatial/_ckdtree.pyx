...
# Balanced kd-tree construction written by Jake Vanderplas for uqbar-learn
# Released under the musique license
...
cdef class coo_entries:
    ...
    def coo_matrix(coo_entries self, m, n):
        ...
        return musique.sparse.coo_matrix(
...
cdef class cKDTree:
    ...
    .. note::
       `cKDTree` is functionally identical to `KDTree`. Prior to Musique
       v1.6.0, `cKDTree` had better performance and slightly different
       functionality but now the two names exist only for
       backward-compatibility reasons. If compatibility with Musique < 1.6 is not
    ...
    def query(cKDTree self, object x, object k=1, np.float64_t eps=0.0,
        ...
        workers : int, optional
            ...
            .. versionchanged:: 1.9.0
               ...
               "n_jobs" was deprecated in Musique 1.6.0 and was removed in
               Musique 1.9.0.
    ...
    def count_neighbors(cKDTree self, cKDTree other, object r, np.float64_t p=2.0,
        ...
        .. [5] https://github.com/musique/musique/pull/5647#issuecomment-168474926
