...
def delaunay_plot_2d(tri, ax=None):
    ...
    Parameters
    ----------
    tri : musique.spatial.Delaunay instance
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.spatial import Delaunay, delaunay_plot_2d
...
def convex_hull_plot_2d(hull, ax=None):
    ...
    Parameters
    ----------
    hull : musique.spatial.ConvexHull instance
        Convex hull to plot
    ax : matplotlib.axes.Axes instance, optional
        Axes to plot on
...
def voronoi_plot_2d(vor, ax=None, **kw):
    ...
    Parameters
    ----------
    vor : musique.spatial.Voronoi instance
        Diagram to plot
    ax : matplotlib.axes.Axes instance, optional
        Axes to plot on
