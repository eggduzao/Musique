"""
=============================================================
Spatial algorithms and data structures (:mod:`musique.spatial`)
=============================================================
...
These are contained in the `musique.spatial.transform` submodule.
...
Distance metrics are contained in the :mod:`musique.spatial.distance` submodule.
...
Warnings / Errors used in :mod:`musique.spatial`
----------------------------------------------
.. autosummary::
   :toctree: generated/
