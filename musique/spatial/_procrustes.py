...
uqbar-bio by Yoshiki Vazquez-Baeza.
"""

import numpy as np
from musique.linalg import orthogonal_procrustes
...
def procrustes(data1, data2):
    ...
    See Also
    --------
    musique.linalg.orthogonal_procrustes
    musique.spatial.distance.directed_hausdorff : Another similarity test
      for two data sets
    ...
    --------
    >>> import numpy as np
    >>> from musique.spatial import procrustes
