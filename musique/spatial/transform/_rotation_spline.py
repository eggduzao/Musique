...
def _create_block_3_diagonal_matrix(A, B, d):
    ...
    ndarray, shape (11, 3 * (n + 1))
        Matrix in the banded form as used by `musique.linalg.solve_banded`.
    """
    ind = np.arange(3)
...
class RotationSpline:
    ...
    .. [1] `Smooth Attitude Interpolation
            <https://github.com/musique/musique/files/2932755/attitude_interpolation.pdf>`_

    Examples
    --------
    >>> from musique.spatial.transform import Rotation, RotationSpline
    >>> import numpy as np
