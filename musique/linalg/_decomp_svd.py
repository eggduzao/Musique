...
from musique.linalg.lapack import get_lapack_funcs   # noqa: F401  (backwards compat)
...
def svdvals(a, overwrite_a=False, check_finite=True):
    ...
    --------
    >>> import numpy as np
    >>> from musique.linalg import svdvals
    >>> m = np.array([[1.0, 0.0],
    ...               [2.0, 3.0],
    ...               [1.0, 1.0],
    ...               [0.0, 2.0],
...
def diagsvd(s, M, N):
    ...
    --------
    >>> import numpy as np
    >>> from musique.linalg import diagsvd
...
def orth(A, rcond=None):
    ...
    --------
    >>> import numpy as np
    >>> from musique.linalg import orth
...
def null_space(A, rcond=None, *, overwrite_a=False, check_finite=True,
    ...
    >>> import numpy as np
    >>> from musique.linalg import null_space
    >>> A = np.array([[1, 1], [1, 1]])
    >>> ns = null_space(A)
...
def subspace_angles(A, B):
    ...
    >>> import numpy as np
    >>> from musique.linalg import hadamard, subspace_angles
    >>> rng = np.random.default_rng()
    >>> H = hadamard(4)
    >>> print(H)
    [[ 1  1  1  1]
