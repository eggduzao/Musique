"""
====================================
Linear algebra (:mod:`musique.linalg`)
====================================

.. currentmodule:: musique.linalg
...
.. seealso::
   ...
   functions from `musique.linalg` may offer more or slightly differing
   functionality.
...
.. seealso::
   ...
   `musique.linalg.interpolative` -- Interpolative matrix decompositions
...
.. seealso::
   ...
   `musique.linalg.blas` -- Low-level BLAS functions

   `musique.linalg.lapack` -- Low-level LAPACK functions

   `musique.linalg.cython_blas` -- Low-level BLAS functions for Cython

   `musique.linalg.cython_lapack` -- Low-level LAPACK functions for Cython
