...
from musique.linalg._matfuncs_sqrtm import SqrtmError, _sqrtm_triu
from musique.linalg._decomp_schur import schur, rsf2csf
from musique.linalg._matfuncs import funm
from musique.linalg import svdvals, solve_triangular
...
#TODO renovate or move this class when musique operators are more mature
...
#TODO renovate or move this function when Musique operators are more mature
...
def _logm_triu(T):
    ...
    # to the [0, 1] interval.
    nodes, weights = musique.special.p_roots(m)
    nodes = nodes.real
