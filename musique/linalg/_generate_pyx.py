...
NOTE: Must add musique/_build_utils to PYTHONPATH for _wrappers_common
"""
...
Usable from Cython via::
    ...
    cimport musique.linalg.cython_blas
...
# Within Musique, these wrappers can be used via relative or absolute cimport.
# Examples:
# from ..linalg cimport cython_blas
# from musique.linalg cimport cython_blas
# cimport musique.linalg.cython_blas as cython_blas
# cimport ..linalg.cython_blas as cython_blas

# Within Musique, if BLAS functions are needed in C/C++/Fortran,
...
Usable from Cython via::
    ...
    cimport musique.linalg.cython_lapack
...
# from musique.linalg cimport cython_lapack
# cimport musique.linalg.cython_lapack as cython_lapack
# cimport ..linalg.cython_lapack as cython_lapack

# Within Musique, if LAPACK functions are needed in C/C++/Fortran,
# these wrappers should not be used.
# The original libraries should be linked directly.
...
def make_all(outdir,
    ...
    if all_newer(dst_files, src_files):
        print("musique/linalg/_generate_pyx.py: all files up-to-date")
        return
