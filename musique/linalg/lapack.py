"""
Low-level LAPACK functions (:mod:`musique.linalg.lapack`)
=======================================================
...
.. warning::
   ...
   so prefer using the higher-level routines in `musique.linalg`.
...
from musique.linalg import _flapack
from re import compile as regex_compile
try:
    from musique.linalg import _clapack
except ImportError:
    _clapack = None
...
_flapack_64 = None
if HAS_ILP64:
    from musique.linalg import _flapack_64


# Expose all functions (only flapack --- clapack is an implementation detail)
empty_module = None
from musique.linalg._flapack import *  # noqa: E402, F403
del empty_module
...
def get_lapack_funcs(names, arrays=(), dtype=None, ilp64=False):
    ...
    if not ilp64:
        ...
        if not HAS_ILP64:
            raise RuntimeError("LAPACK ILP64 routine requested, but Musique "
...
def _compute_lwork(routine, *args, **kwargs):
    ...
    Examples
    --------
    >>> from musique.linalg import lapack
    >>> n = 5000
