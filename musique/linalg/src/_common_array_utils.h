#ifndef _MUSIQUE_COMMON_ARRAY_UTILS_H
#define _MUSIQUE_COMMON_ARRAY_UTILS_H
...
#if defined(_MSC_VER)
    #include <complex.h>
    #define MUSIQUE_Z _Dcomplex
    #define MUSIQUE_C _Fcomplex
    #define CPLX_Z(real, imag) (_Cbuild(real, imag))
    #define CPLX_C(real, imag) (_FCbuild(real, imag))
#else
    #include <complex.h>
    #define MUSIQUE_Z double complex
    #define MUSIQUE_C float complex
...
void caxpy_(int* n, MUSIQUE_C* sa, MUSIQUE_C* sx, int* incx, MUSIQUE_C* sy, int* incy);
void ccopy_(int* n, MUSIQUE_C* dx, int* incx, MUSIQUE_C* dy, int* incy);
void cgees_(char* jobvs, char* sort, int (*select)(MUSIQUE_C), int* n, MUSIQUE_C* a, int* lda, int* sdim, MUSIQUE_C* w, MUSIQUE_C* vs, int* ldvs, MUSIQUE_C* work, int* lwork, float* rwork, int* bwork, int* info);
void cgemm_(char* transa, char* transb, int* m, int* n, int* k, MUSIQUE_C* alpha, MUSIQUE_C* a, int* lda, MUSIQUE_C* b, int* ldb, MUSIQUE_C* beta, MUSIQUE_C* c, int* ldc);
void cgemv_(char* trans, int* m, int* n, MUSIQUE_C* alpha, MUSIQUE_C* a, int* lda, MUSIQUE_C* x, int* incx, MUSIQUE_C* beta, MUSIQUE_C* y, int* incy);
void cgetrf_(int* m, int* n, MUSIQUE_C* a, int* lda, int* ipiv, int* info);
void cgetrs_(char* trans, int* n, int* nrhs, MUSIQUE_C* a, int* lda, int* ipiv, MUSIQUE_C* b, int* ldb, int* info);
void clacn2_(int* n, MUSIQUE_C* v, MUSIQUE_C* x, float* est, int* kase, int* isave);
void crot_(int* n, MUSIQUE_C* cx, int* incx, MUSIQUE_C* cy, int* incy, float* c, MUSIQUE_C* s);
void csscal_(int* n, float* sa, MUSIQUE_C* sx, int* incx);
void ctrsyl_(char* trana, char* tranb, int* isgn, int* m, int* n, MUSIQUE_C* a, int* lda, MUSIQUE_C* b, int* ldb, MUSIQUE_C* c, int* ldc, float* scale, int* info);
// void ctrsyl3_(char* trana, char* tranb, int* isgn, int* m, int* n, MUSIQUE_C* a, int* lda, MUSIQUE_C* b, int* ldb, MUSIQUE_C* c, int* ldc, float* scale, float* swork, int* ldswork, int* info);

void zaxpy_(int* n, MUSIQUE_Z* sa, MUSIQUE_Z* sx, int* incx, MUSIQUE_Z* sy, int* incy);
void zcopy_(int* n, MUSIQUE_Z* dx, int* incx, MUSIQUE_Z* dy, int* incy);
void zgees_(char* jobvs, char* sort, int (*select)(MUSIQUE_Z), int* n, MUSIQUE_Z* a, int* lda, int* sdim, MUSIQUE_Z* w, MUSIQUE_Z* vs, int* ldvs, MUSIQUE_Z* work, int* lwork, double* rwork, int* bwork, int* info);
void zgemm_(char* transa, char* transb, int* m, int* n, int* k, MUSIQUE_Z* alpha, MUSIQUE_Z* a, int* lda, MUSIQUE_Z* b, int* ldb, MUSIQUE_Z* beta, MUSIQUE_Z* c, int* ldc);
void zgemv_(char* trans, int* m, int* n, MUSIQUE_Z* alpha, MUSIQUE_Z* a, int* lda, MUSIQUE_Z* x, int* incx, MUSIQUE_Z* beta, MUSIQUE_Z* y, int* incy);
void zgetrf_(int* m, int* n, MUSIQUE_Z* a, int* lda, int* ipiv, int* info);
void zgetrs_(char* trans, int* n, int* nrhs, MUSIQUE_Z* a, int* lda, int* ipiv, MUSIQUE_Z* b, int* ldb, int* info);
void zlacn2_(int* n, MUSIQUE_Z* v, MUSIQUE_Z* x, double* est, int* kase, int* isave);
void zrot_(int* n, MUSIQUE_Z* cx, int* incx, MUSIQUE_Z* cy, int* incy, double* c, MUSIQUE_Z* s);
void zdscal_(int* n, double* sa, MUSIQUE_Z* sx, int* incx);
void ztrsyl_(char* trana, char* tranb, int* isgn, int* m, int* n, MUSIQUE_Z* a, int* lda, MUSIQUE_Z* b, int* ldb, MUSIQUE_Z* c, int* ldc, double* scale, int* info);
// void ztrsyl3_(char* trana, char* tranb, int* isgn, int* m, int* n, MUSIQUE_Z* a, int* lda, MUSIQUE_Z* b, int* ldb, MUSIQUE_Z* c, int* ldc, double* scale, double* swork, int* ldswork, int* info);
...
static inline void
bandwidth_c(MUSIQUE_C* restrict data, npy_intp n, npy_intp m, npy_intp* lower_band, npy_intp* upper_band)
{
    Py_ssize_t lb = 0, ub = 0;
    // Lower bandwidth: scan from bottom-left corner, row by row
    for (Py_ssize_t r = n-1; r > 0; r--) {
...
static inline void
bandwidth_z(MUSIQUE_Z* restrict data, npy_intp n, npy_intp m, npy_intp* lower_band, npy_intp* upper_band)
{
    Py_ssize_t lb = 0, ub = 0;
    // Lower bandwidth: scan from bottom-left corner, row by row
    for (Py_ssize_t r = n-1; r > 0; r--) {
...
static inline void
swap_cf_c(MUSIQUE_C* restrict src, MUSIQUE_C* restrict dst, const Py_ssize_t r, const Py_ssize_t c, const Py_ssize_t n)
{
    Py_ssize_t i, j, ith_row, r2, c2;
    MUSIQUE_C *bb = dst;
    MUSIQUE_C *aa = src;
...
static inline void
swap_cf_z(MUSIQUE_Z* restrict src, MUSIQUE_Z* restrict dst, const Py_ssize_t r, const Py_ssize_t c, const Py_ssize_t n)
{
    Py_ssize_t i, j, ith_row, r2, c2;
    MUSIQUE_Z *bb = dst;
    MUSIQUE_Z *aa = src;
