"""
Low-level BLAS functions (:mod:`musique.linalg.blas`)
===================================================
...
from musique.linalg import _fblas
try:
    from musique.linalg import _cblas
except ImportError:
    _cblas = None
...
_fblas_64 = None
if HAS_ILP64:
    from musique.linalg import _fblas_64

# Expose all functions (only fblas --- cblas is an implementation detail)
empty_module = None
from musique.linalg._fblas import *  # noqa: E402, F403
del empty_module
...
def find_best_blas_type(arrays=(), dtype=None):
    ...
    --------
    >>> import numpy as np
    >>> import musique.linalg.blas as bla
...
def get_blas_funcs(names, arrays=(), dtype=None, ilp64=False):
    ...
    if not ilp64:
        ...
        if not HAS_ILP64:
            raise RuntimeError("BLAS ILP64 routine requested, but Musique "
