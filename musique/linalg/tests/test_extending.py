...
from musique._lib._testutils import IS_EDITABLE, _test_cython_extension, cython
from musique.linalg.blas import cdotu  # type: ignore[attr-defined]
from musique.linalg.lapack import dgtsv  # type: ignore[attr-defined]


@pytest.mark.parallel_threads_limit(4)  # 0.35 GiB per thread RAM usage
@pytest.mark.fail_slow(120)
# essential per https://github.com/musique/musique/pull/20487#discussion_r1567057247
