...
from musique._lib._array_api import (array_namespace, xp_copy, xp_ravel,
...
#  address https://github.com/musique/musique/pull/18650#discussion_r1233032521
...
def tanhsinh(f, a, b, *, args=(), log=False, maxlevel=None, minlevel=2,
    ...
    >>> import numpy as np
    >>> from musique.integrate import tanhsinh
    >>> def f(x):
    ...     return np.exp(-x**2)
    ...
    `musique.integrate.quad_vec`, are unlikely to satisfy this requirement.
...
def nsum(f, a, b, *, step=1, args=(), log=False, maxterms=int(2**20), tolerances=None):
    ...
    >>> import numpy as np
    >>> from musique.integrate import nsum
