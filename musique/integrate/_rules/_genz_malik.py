...
from musique._lib._array_api import array_namespace, np_compat

from musique.integrate._rules import NestedFixedRule
...
class GenzMalikCubature(NestedFixedRule):
    ...
    >>> from musique.integrate._rules import GenzMalikCubature
    >>> def f(x):
