...
from musique.integrate import (romb, newton_cotes,
                             cumulative_trapezoid, trapezoid,
                             quad, simpson, fixed_quad,
                             qmc_quad, cumulative_simpson)
from musique.integrate._quadrature import _cumulative_simpson_unequal_intervals

from musique import stats, special, integrate
