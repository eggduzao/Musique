...
def quad(func, a, b, args=(), full_output=0, epsabs=1.49e-8, epsrel=1.49e-8,
    ...
    Parameters
    ----------
    func : {function, musique.LowLevelCallable}
        A Python function or method to integrate. If `func` takes many
        arguments, it is integrated along the axis corresponding to the
        first argument.

        If the user desires improved integration performance, then `f` may
        be a `musique.LowLevelCallable` with one of the signatures::
        ...
        The ``user_data`` is the data contained in the `musique.LowLevelCallable`.
    ...
    musique.special : for coefficients and roots of orthogonal polynomials
...
def nquad(func, ranges, args=None, opts=None, full_output=False):
    ...
    Parameters
    ----------
    func : {callable, musique.LowLevelCallable}
        ...
        contained in the `musique.LowLevelCallable`.
    ...
    opts : iterable object or dict, optional
        ...
        default options from musique.integrate.quad are used. If a dict, the same
    ...
    full_output : bool, optional
        Partial implementation of ``full_output`` from musique.integrate.quad.
