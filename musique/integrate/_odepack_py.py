...
def odeint(func, y0, t, args=(), Dfun=None, col_deriv=0, full_output=0,
    ...
    .. note:: For new code, use `musique.integrate.solve_ivp` to solve a
    ...
    .. note:: By default, the required order of the first two arguments of
              ...
              definition function used by the `musique.integrate.ode` class and
              the function `musique.integrate.solve_ivp`. To use a function with
    ...
    >>> from musique.integrate import odeint
