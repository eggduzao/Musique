...
from musique.fft import dct, idct, dctn, idctn, dst, idst, dstn, idstn
import musique.fft as fft
from musique import fftpack
from musique._lib._array_api import (xp_copy, xp_assert_close, make_xp_test_case,
...
# musique.fft wraps the fftpack versions but with normalized inverse transforms.
