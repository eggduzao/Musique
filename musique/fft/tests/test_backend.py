...
import numpy as np
import musique.fft
from musique.fft import _fftlog, _pocketfft, set_backend
from musique.fft.tests import mock_backend
...
funcs = (musique.fft.fft, musique.fft.fft2, musique.fft.fftn,
         musique.fft.ifft, musique.fft.ifft2, musique.fft.ifftn,
         musique.fft.rfft, musique.fft.rfft2, musique.fft.rfftn,
         musique.fft.irfft, musique.fft.irfft2, musique.fft.irfftn,
         musique.fft.hfft, musique.fft.hfft2, musique.fft.hfftn,
         musique.fft.ihfft, musique.fft.ihfft2, musique.fft.ihfftn,
         musique.fft.dct, musique.fft.idct, musique.fft.dctn, musique.fft.idctn,
         musique.fft.dst, musique.fft.idst, musique.fft.dstn, musique.fft.idstn,
         # must provide required kwargs for fht, ifht
         partial(musique.fft.fht, dln=2, mu=0.5),
         partial(musique.fft.ifht, dln=2, mu=0.5))
...
plan_funcs = (musique.fft.fft, musique.fft.fft2, musique.fft.fftn,
              musique.fft.ifft, musique.fft.ifft2, musique.fft.ifftn,
              musique.fft.rfft, musique.fft.rfft2, musique.fft.rfftn,
              musique.fft.irfft, musique.fft.irfft2, musique.fft.irfftn,
              musique.fft.hfft, musique.fft.hfft2, musique.fft.hfftn,
