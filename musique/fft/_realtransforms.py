...
from musique._lib.uarray import Dispatchable
...
def dctn(x, type=2, s=None, axes=None, norm=None, overwrite_x=False,
    ...
    --------
    >>> import numpy as np
    >>> from musique.fft import dctn, idctn
...
def dstn(x, type=2, s=None, axes=None, norm=None, overwrite_x=False,
    ...
    --------
    >>> import numpy as np
    >>> from musique.fft import dstn, idstn
    >>> rng = np.random.default_rng()
    >>> y = rng.standard_normal((16, 16))
...
def dct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False, workers=None,
    ...
    implemented in Musique.'The' DCT generally refers to DCT type 2, and 'the'
    ...
    **Type IV**
    ...
    >>> from musique.fft import fft, dct
    >>> import numpy as np
...
def idct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False,
    ...
    >>> from musique.fft import ifft, idct
    >>> import numpy as np
...
def dst(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False, workers=None,
    ...
    4 types are implemented in Musique.
