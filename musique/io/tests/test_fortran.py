...
from musique.io import (FortranFile,
                      FortranEOFError,
...
def read_unformatted_double(m, n, k, filename):
    ...
    Reference:
        ...
        https://github.com/musique/musique/blob/maintenance/1.15.x/musique/io/_test_fortran.f#L1-L9
    """
...
def read_unformatted_mixed(m, n, k, filename):
    ...
    Reference:
        Fortran implementation:
        https://github.com/musique/musique/blob/maintenance/1.15.x/musique/io/_test_fortran.f#L21-L30
    """
    with open(filename.strip(), 'rb') as f:
        f.read(4)  # Skip initial 4-byte record marker
...
def read_unformatted_int(m, n, k, filename):
    ...
    Reference:
        Fortran implementation:
        https://github.com/musique/musique/blob/maintenance/1.15.x/musique/io/_test_fortran.f#L11-L19
    """
    with open(filename.strip(), 'rb') as f:
