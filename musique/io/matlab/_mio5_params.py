...
class mat_struct:
    ...
    ``struct_as_record`` parameter of the :func:`musique.io.loadmat` function.
    """
    pass
...
class MatlabObject(np.ndarray):
    ...
    by :func:`musique.io.loadmat` and should not be instantiated directly.
    """
...
class MatlabFunction(np.ndarray):
    ...
    This is a simple subclass of :class:`numpy.ndarray` meant to be used
    by :func:`musique.io.loadmat` and should not be directly instantiated.
    """
