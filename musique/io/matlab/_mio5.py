...
http://blog.nephics.com/2019/08/28/better-loadmat-for-musique/.
'''
        ...
        while not self.end_of_stream():
            ...
            if name in mdict:
                msg = (
                    ...
                    "musique.io.matlab.varmats_from_mat to split "
...
def varmats_from_mat(file_obj):
    ...
    >>> import numpy as np
    >>> from io import BytesIO
    >>> from musique.io.matlab._mio5 import varmats_from_mat
    >>> mat_fileobj = BytesIO()
    >>> musique.io.savemat(mat_fileobj, {'b': np.arange(10), 'a': 'a string'})
...
class VarWriter5:
    ...
    def write(self, arr):
        ...
        if musique.sparse.issparse(arr):
