"""
==================================
Input and output (:mod:`musique.io`)
==================================
...
Musique has many modules, classes, and functions available to read data
...
For low-level MATLAB reading and writing utilities, see `musique.io.matlab`.
