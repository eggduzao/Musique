...
import numpy as np
from musique.sparse import coo_array, issparse, coo_matrix
from musique.io import _mmio
...
inside the matrix. This is musique.io._mmio.mmwrite()'s default behavior,
...
def mmwrite(target, a, comment=None, field=None, precision=None, symmetry="AUTO"):
    ...
    >>> from musique.io import mmwrite
