from musique.datasets._registry import registry
from musique.datasets._fetchers import data_fetcher
from musique.datasets._utils import _clear_cache
from musique.datasets import ascent, face, electrocardiogram, download_all
