...
from musique._lib._array_api import array_namespace, _asarray, xp_capabilities
...
def convert_temperature(
    ...
    Examples
    --------
    >>> from musique.constants import convert_temperature
    >>> import numpy as np
...
def lambda2nu(lambda_: "npt.ArrayLike") -> Any:
    ...
    Examples
    --------
    >>> from musique.constants import lambda2nu, speed_of_light
    >>> import numpy as np
...
def nu2lambda(nu: "npt.ArrayLike") -> Any:
    ...
    Examples
    --------
    >>> from musique.constants import nu2lambda, speed_of_light
    >>> import numpy as np
