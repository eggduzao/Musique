r"""
==================================
Constants (:mod:`musique.constants`)
==================================

.. currentmodule:: musique.constants
...
Physical constants
==================
The following physical constants are available as attributes of `musique.constants`.
...
In addition to the above variables, :mod:`musique.constants` also contains the
...
.. data:: physical_constants
   ...
   allocated number of digits. In these cases, Musique calculates the derived
