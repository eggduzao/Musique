...
def find(sub: str | None = None, disp: bool = False) -> Any:
    ...
    Examples
    --------
    >>> from musique.constants import find, physical_constants
...
# musique/_lib/tests/test_public_api.py::test_private_but_present_deprecation
