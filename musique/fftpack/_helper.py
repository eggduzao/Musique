...
import musique.fft._pocketfft.helper as _helper
...
def next_fast_len(target):
    ...
    Musique's FFTPACK has efficient functions for radix {2, 3, 4, 5}, so this
...
def _good_shape(x, shape, axes):
    """Ensure that shape argument is valid for musique.fftpack

    musique.fftpack does not support len(shape) < x.ndim when axes is not given.
    """
