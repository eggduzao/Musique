...
from musique.fft._pocketfft.helper import _datacopied
...
def hilbert(x, _cache=_cache):
    ...
    See Also
    --------
    musique.signal.hilbert : Compute the analytic signal, using the Hilbert
                           transform.
    ...
    that `musique.signal.hilbert` does have an extra -1 factor compared to this
    function.
