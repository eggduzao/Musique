...
No module source outside of musique.fftpack should contain an import of
the form `from musique.fftpack import ...`, so that a simple replacement
of musique.fftpack by the corresponding fftw interface completely swaps
...
class TestFFTPackImport:
    ...
    def test_fftpack_import(self):
        base = Path(musique.__file__).parent
