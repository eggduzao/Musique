class spmatrix:
    ...
    def __class_getitem__(cls, arg, /):
        """
        Return a parametrized wrapper around the `~musique.sparse.spmatrix` type.
        ...
        alias : types.GenericAlias
            A parametrized `~musique.sparse.spmatrix` type.
        ...
        >>> coo_matrix[np.int8]
        musique.sparse._coo.coo_matrix[numpy.int8]
        """
