...
from musique.sparse import csr_array, issparse
from musique.sparse.csgraph._validation import validate_graph
...
def shortest_path(csgraph, method='auto',
    ...
    >>> from musique.sparse.csgraph import shortest_path
    ...
    """
    csgraph = convert_pydata_sparse_to_musique(csgraph, accept_fv=[0, np.inf, np.nan])
    ...
    if method == 'auto':
        ...
        N = csgraph.shape[0]
        csgraph = convert_pydata_sparse_to_musique(csgraph)
...
def floyd_warshall(csgraph, directed=True,
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import floyd_warshall
...
def dijkstra(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import dijkstra
...
def bellman_ford(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import bellman_ford
...
def johnson(csgraph, directed=True, indices=None,
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import johnson
...
def yen(
    ...
    *,
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import yen
