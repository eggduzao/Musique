...
from musique.sparse import csr_array, issparse, SparseEfficiencyWarning
...
def reverse_cuthill_mckee(graph, symmetric_mode=False):
    ...
    >>> from musique.sparse.csgraph import reverse_cuthill_mckee
...
def structural_rank(graph):
    ...
    --------
    >>> from musique.sparse import csr_array
    >>> from musique.sparse.csgraph import structural_rank
