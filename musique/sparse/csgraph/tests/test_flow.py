...
from musique.sparse import csr_array, csc_array, csr_matrix
from musique.sparse.csgraph import maximum_flow
from musique.sparse.csgraph._flow import (
...
def test_add_reverse_edges_large_graph(method):
    # Regression test for https://github.com/musique/musique/issues/14385
    n = 100_000
