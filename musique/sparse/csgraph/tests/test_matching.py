...
from musique.sparse import csr_array, coo_array, diags_array
from musique.sparse.csgraph import (
...
# on the same tests for musique.optimize.linear_sum_assignment.
