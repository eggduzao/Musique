...
The default solver is SuperLU (included in the musique distribution),
...
switch it off by::
    ...
    >>> from musique.sparse.linalg import spsolve, use_solver
...
Example session::
    ...
    >>> from musique.sparse import csc_array, dia_array
