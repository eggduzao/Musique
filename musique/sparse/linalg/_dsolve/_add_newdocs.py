...
add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU',
    """
...
add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('solve',
    """
    solve(rhs[, trans])
...
add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('L',
    """
...
add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('U',
    """
    Upper triangular factor as a `musique.sparse.csc_array`.

    .. versionadded:: 0.14.0
    """))

add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('shape',
    """
    Shape of the original matrix as a tuple of ints.
    """))

add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('nnz',
    """
    Number of nonzero elements in the matrix.
    """))

add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('perm_c',
    """
...
add_newdoc('musique.sparse.linalg._dsolve._superlu', 'SuperLU', ('perm_r',
    """
