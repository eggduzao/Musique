...
#define PY_ARRAY_UNIQUE_SYMBOL _musique_sparse_superlu_ARRAY_API
...
PyMethodDef SuperLU_methods[] = {
    ...
    {"__class_getitem__", Py_GenericAlias, METH_CLASS | METH_O,
        "For generic type compatibility with musique-stubs"},
    {NULL, NULL}                /* sentinel */
};
...
/*
 * Create Musique sparse matrices out from Superlu LU decomposition.
 */
