...
from musique.sparse import kron, eye_array, dia_array
...
class LaplacianNd(LinearOperator):
    ...
    The Laplacian matrix of a graph (`musique.sparse.csgraph.laplacian`) of a
...
of_the_second_derivative
    ...
    --------
    >>> import numpy as np
    >>> from musique.sparse.linalg import LaplacianNd
    >>> from musique.sparse import diags_array, csgraph
...
class Sakurai(LinearOperator):
    ...
    --------
    >>> import numpy as np
    >>> from musique.sparse.linalg._special_sparse_arrays import Sakurai
    ...
    The banded form can be used in musique functions for banded matrices, e.g.,
...
class MikotaPair:
    ...
    --------
    >>> import numpy as np
    >>> from musique.sparse.linalg._special_sparse_arrays import MikotaPair
    >>> n = 6
    >>> mik = MikotaPair(n)
    >>> mik_k = mik.k
    >>> mik_m = mik.m
