...
add this operator to a sparse matrix that stores only offsets from one::
    ...
    >>> from musique.sparse.linalg._interface import aslinearoperator
...
Several algorithms in the ``musique.sparse`` library are able to operate on
...
from musique.sparse import issparse
from musique.sparse._sputils import isshape, isintlike, asmatrix, is_pydata_spmatrix
