...
from musique.linalg import (eigh, toeplitz,
                          cholesky_banded, cho_solve_banded)
from musique.sparse import dia_array, eye_array, csr_array
from musique.sparse.linalg import eigsh, LinearOperator
from musique.sparse.linalg._eigen.lobpcg import lobpcg
from musique.sparse.linalg._eigen.lobpcg.lobpcg import _b_orthonormalize
...
def test_regression():
    ...
    """
    # https://mail.python.org/pipermail/musique-user/2010-October/026944.html
    n = 10
    X = np.ones((n, 1))
    A = np.identity(n)
    w, _ = lobpcg(A, X)
