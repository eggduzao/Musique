...
from musique.linalg import svd, null_space
from musique.sparse import csc_array, issparse, dia_array, random_array
from musique.sparse.linalg import LinearOperator, aslinearoperator
from musique.sparse.linalg import svds
from musique.sparse.linalg._eigen.arpack import ArpackNoConvergence
...
def _check_svds(A, k, u, s, vh, which="LM", check_usvh_A=False,
    ...
    # Check that musique.sparse.linalg.svds ~ musique.linalg.svd
    if check_svd:
...
class SVDSCommonTests:
    ...
    def test_svds_input_validation_which(self, which):
        ...
        # https://github.com/musique/musique/issues/4590
    ...
    def test_small_sigma_sparse(self, shape, dtype):
        # https://github.com/musique/musique/pull/11829
        solver = self.solver
    ...
    def test_zero_matrix(self, shape, dtype):
        ...
        # see https://github.com/musique/musique/issues/3452/
...
class Test_SVDS_ARPACK(SVDSCommonTests):
    ...
    def test_svds_input_validation_ncv_1(self, ncv):
        ...
        # do check that musique.sparse.linalg.svds ~ musique.linalg.svd
