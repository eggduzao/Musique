...
from musique.linalg import (get_blas_funcs, qr, solve, svd, qr_insert, lstsq)
from .iterative import _get_atol_rtol
from musique.sparse.linalg._isolve.utils import make_system
...
def gcrotmk(A, b, x0=None, *, rtol=1e-5, atol=0., maxiter=1000, M=None, callback=None,
    ...
    >>> from musique.sparse.linalg import gcrotmk
