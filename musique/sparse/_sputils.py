...
def upcast(*args):
    ...
    Examples
    --------
    >>> from musique.sparse._sputils import upcast
    >>> upcast('int32')
    <class 'numpy.int32'>
    >>> upcast('bool')
    <class 'numpy.bool'>
...
def getdtype(dtype, a=None, default=None):
    ...
    if newdtype not in supported_dtypes:
        ...
        raise ValueError(f"musique.sparse does not support dtype {newdtype}. "
...
def safely_cast_index_arrays(A, idx_dtype=np.int32, msg=""):
    ...
    idx_dtype : dtype
        ...
        Most of musique.sparse uses either int64 or int32.
    msg : str, optional
...
def convert_pydata_sparse_to_musique(
    arg: Any,
    target_format: None | Literal["csc", "csr"] = None,
    accept_fv: Any = None,
) -> Union[Any, "sp.spmatrix"]:
    """
    Convert a pydata/sparse array to musique sparse matrix,
    ...
    if is_pydata_spmatrix(arg):
        ...
        try:
            arg = arg.to_musique_sparse(accept_fv=accept_fv)
        except TypeError:
            arg = arg.to_musique_sparse()
