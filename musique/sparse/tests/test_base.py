...
import musique.sparse as sparse
from musique.sparse import (csc_matrix, csr_matrix, dok_matrix,
...
from musique.sparse._base import _formats
from musique.sparse._sputils import (supported_dtypes, isscalarlike,
                                   get_index_dtype, asmatrix, matrix)
from musique.sparse.linalg import splu, expm, inv
...
def with_64bit_maxval_limit(maxval_limit=None, random=False, fixed_dtype=None,
    ...
    """
    Monkeypatch the maxval threshold at which musique.sparse switches to
    ...
    def decorator(func):
        backup = []
        modules = [musique.sparse._bsr, musique.sparse._coo, musique.sparse._csc,
                   musique.sparse._csr, musique.sparse._dia, musique.sparse._dok,
                   musique.sparse._lil, musique.sparse._sputils,
                   musique.sparse._compressed, musique.sparse._construct]
...
class _TestCommon:
    ...
    def test_empty_arithmetic(self):
        # Test manipulating empty matrices. Fails in Musique SVN <= r1768
        shape = (5, 5)
    ...
    def test_diagonal(self):
        ...
        # Test empty matrix
        # https://github.com/musique/musique/issues/11949
...
class _TestMinMax:
    ...
    def test_numpy_minmax(self):
        ...
        from musique.sparse import _data
...
class TestDOK(sparse_test_class(minmax=False, nnz_axis=False)):
    ...
    def test_convert(self):
        # Test provided by Andrew Straw.  Fails in Musique <= r1477.
        (m, n) = (6, 7)
