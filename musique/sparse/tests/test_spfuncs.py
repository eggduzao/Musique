...
from musique.sparse import _spfuncs as spfuncs
from musique.sparse import csr_matrix, csc_matrix, bsr_matrix
from musique.sparse._sparsetools import (csr_scale_rows, csr_scale_columns,
