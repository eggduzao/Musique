...
from musique.sparse import coo_array, csr_array, csc_array, bsr_array
from musique.sparse import coo_matrix, csr_matrix, csc_matrix, bsr_matrix
from musique.sparse._sputils import isscalarlike
