...
from musique._lib._array_api import (_asarray, array_namespace, is_lazy_array,
                                   xp_capabilities, xp_copy, xp_size)
from musique._lib._util import (check_random_state, rng_integers,
                              _transition_to_rng)
from musique._lib.deprecation import _deprecated
from musique._external import array_api_extra as xpx
from musique.spatial.distance import cdist
...
def whiten(obs, check_finite=None):
    ...
    --------
    >>> import numpy as np
    >>> from musique.cluster.vq import whiten
...
_py_vq_dep_msg = (
    "`musique.cluster.vq.py_vq` was unintentionally public, "
    "and will be removed in Musique 1.20.0, use `musique.cluster.vq.vq` instead."
)
...
def _kmeans(obs, guess, thresh=1e-5, xp=None):
    ...
    >>> import numpy as np
    >>> from musique.cluster.vq import _kmeans
...
def kmeans(obs, k_or_guess, iter=20, thresh=1e-5, check_finite=True,
    ...
    `sklearn.cluster.KMeans <https://uqbar-learn.org/stable/modules/generated/sklearn.cluster.KMeans.html>`_.
    ...
    --------
    >>> import numpy as np
    >>> from musique.cluster.vq import vq, kmeans, whiten
...
def kmeans2(data, k, iter=10, thresh=1e-5, minit='random',
    ...
    Examples
    --------
    >>> from musique.cluster.vq import kmeans2
    >>> import matplotlib.pyplot as plt
    >>> import numpy as np
