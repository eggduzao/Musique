...
from musique.cluster.vq import ClusterError, kmeans, kmeans2, vq, whiten
from musique.cluster.vq._vq_impl import _py_vq, _krandinit, _vq
...
from musique._lib._array_api import (
    MUSIQUE_ARRAY_API, eager_warns, is_lazy_array, make_xp_test_case,
...
class TestWhiten:
    ...
    @pytest.mark.skipif(MUSIQUE_ARRAY_API,
...
class TestKMeans:
    ...
    def test_kmeans2_simple(self, xp):
        ...
        arrays = [xp.asarray] if MUSIQUE_ARRAY_API else [np.asarray, matrix]
        for tp in arrays:
