...
from musique._lib._array_api import xp_capabilities, array_namespace, xp_promote
from musique.stats._stats_py import (_SimpleNormal, SignificanceResult, _get_pvalue,
                                   _rankdata)
from musique.stats._axis_nan_policy import _axis_nan_policy_factory
from musique.stats._stats_mstats_common import (TheilslopesResult, _n_samples_optional_x,
                                              SiegelslopesResult)
...
def chatterjeexi(x, y, *, axis=0, y_continuous=False, method='asymptotic'):
    ...
    See Also
    --------
    musique.stats.pearsonr, musique.stats.spearmanr, musique.stats.kendalltau
...
def spearmanrho(x, y, /, *, alternative='two-sided', method=None, axis=0):
    ...
    axis : int or None, optional
        ...
        Like other `musique.stats` functions, `axis` is interpreted after the
    ...
    Notes
    -----
    `spearmanrho` was created to make improvements to Musique's implementation of
