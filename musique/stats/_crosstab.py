...
def crosstab(*args, levels=None, sparse=False):
    ...
    *args : sequences
    ...
    sparse : bool, optional
        ...
        the `musique.sparse.coo_matrix` class.  Because Musique's sparse matrices
    ...
    res : CrosstabResult
        ...
        count : numpy.ndarray or musique.sparse.coo_matrix
    ...
    Examples
    --------
    >>> from musique.stats.contingency import crosstab
