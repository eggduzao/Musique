...
from musique.integrate._quadrature import _builtincoeffs
...
from musique._lib.doccer import inherit_docstring_from
...
#
# Musique's original Stable was a random variate generator. It
...
def _pdf_single_value_piecewise_post_rounding_Z0(x0, alpha, beta, quad_eps,
    ...
    # See https://github.com/musique/musique/pull/18133
    x0 = _nolan_round_x_near_zeta(x0, alpha, zeta, x_tol_near_zeta)
