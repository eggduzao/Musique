...
from musique.special import entr, logsumexp, betaln, gammaln as gamln
...
class nhypergeom_gen(rv_discrete):
    ...
    --------
    >>> import numpy as np
    >>> from musique.stats import nhypergeom
    >>> import matplotlib.pyplot as plt
    ...
    >>> from musique.stats import hypergeom, nhypergeom
    >>> M, n, r = 45, 13, 8
    >>> k = 6
...
class logser_gen(rv_discrete):
    ...
    def _sf(self, k, p):
        ...
        # for `b` super close to zero. See https://github.com/musique/musique/issues/3890.
...
class randint_gen(rv_discrete):
    ...
    --------
    >>> import numpy as np
    >>> from musique.stats import randint
    >>> import matplotlib.pyplot as plt
...
class zipf_gen(rv_discrete):
    ...
    Riemann zeta function (`musique.special.zeta`)
    ...
    >>> import numpy as np
    >>> from musique.stats import zipf, zipfian
    >>> k = np.arange(11)
...
class zipfian_gen(rv_discrete):
    ...
    The Musique implementation of this distribution requires :math:`1 \le n \le 2^{53}`.
...
class yulesimon_gen(rv_discrete):
    ...
    Here :math:`B` refers to the `musique.special.beta` function.
...
class nchypergeom_fisher_gen(_nchypergeom_gen):
    ...
    permission for it to be distributed under Musique's license.
