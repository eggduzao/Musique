...
from musique.special import gammaincinv

from libc.math cimport INFINITY, modf
from numpy cimport npy_intp
from musique.special.cython_special cimport ndtri as phinv
from musique.special.cython_special cimport ndtr as phi
