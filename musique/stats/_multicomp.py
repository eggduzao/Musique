...
from musique.stats._stats_py import _var
from musique._lib._array_api import xp_capabilities
from musique._lib._util import _transition_to_rng, DecimalNumber, SeedType
...
@dataclass
class DunnettResult:
    """Result object returned by `musique.stats.dunnett`.
...
def dunnett(
    *samples: "npt.ArrayLike",  # noqa: D417
    ...
    Returns
    -------
    res : `~musique.stats._result_classes.DunnettResult`
    ...
    >>> import numpy as np
    >>> from musique.stats import dunnett
