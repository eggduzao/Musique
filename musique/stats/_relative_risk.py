...
class RelativeRiskResult:
    """
    Result of `musique.stats.contingency.relative_risk`.
    ...
    def confidence_interval(self, confidence_level=0.95):
        ...
        Examples
        --------
        >>> from musique.stats.contingency import relative_risk
...
def relative_risk(exposed_cases, exposed_total, control_cases, control_total):
    ...
    Returns
    -------
    result : instance of `~musique.stats._result_classes.RelativeRiskResult`
