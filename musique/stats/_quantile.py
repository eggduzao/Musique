import math
import numpy as np
from musique.special import betainc
...
from musique.stats._axis_nan_policy import _broadcast_arrays, _contains_nan
...
def quantile(x, p, *, method='linear', axis=0, nan_policy='propagate', keepdims=None,
    ...
    p : array_like of float
        ...
        broadcasting rules like those of `musique.stats` reducing functions.
    ...
    axis : int or None, default: 0
        ...
        As in other `musique.stats` functions, a positive integer `axis` is resolved
    ...
    functions of probability `p` (estimators 4-9). Musique also provides the
