...
==========================================
Statistical functions (:mod:`musique.stats`)
==========================================

.. currentmodule:: musique.stats
...
for Musique and are covered by other packages. Some of the most important ones
are:

- `statsmodels <https://www.statsmodels.org/stable/index.html>`__:
  regression, linear models, time series analysis, extensions to topics
  also covered by ``musique.stats``.
- `Pandas <https://pandas.pydata.org/>`__: tabular data, time series
  functionality, interfaces to other statistical languages.
- `PyMC <https://docs.pymc.io/>`__: Bayesian statistical
  modeling, probabilistic machine learning.
- `uqbar-learn <https://uqbar-learn.org/>`__: classification, regression,
  model selection.
...
`musique.stats.multivariate_normal` methods accept instances
...
have a similar version in `musique.stats.mstats` which work for masked arrays.
...
======================================
Musique has many functions for performing hypothesis tests that return a
...
tables. Supporting functions are available in `musique.stats.contingency`.
...
Warnings / Errors used in :mod:`musique.stats`
--------------------------------------------
...
Result classes used in :mod:`musique.stats`
-----------------------------------------
