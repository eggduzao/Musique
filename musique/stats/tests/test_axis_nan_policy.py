# Many musique.stats functions support `axis` and `nan_policy` parameters.
# When the two are combined, it can be tricky to get all the behavior just
# right. This file contains a suite of common tests for musique.stats functions
...
from musique.stats._axis_nan_policy import (_masked_arrays_2_sentinel_arrays,
                                          SmallSampleWarning,
...
MUSIQUE_XSLOW = int(os.environ.get('MUSIQUE_XSLOW', '0'))
...
def test_axis_nan_policy_fast(hypotest, args, kwds, n_samples, n_outputs,
                              ...
                              data_generator):
    if hypotest in {stats.kruskal} and not MUSIQUE_XSLOW:
...
if MUSIQUE_XSLOW:
    ...
    # them at all unless `MUSIQUE_XSLOW` is defined.
...
# see https://github.com/musique/musique/issues/22360
...
def test_axis_nan_policy_axis_is_None(hypotest, args, kwds, n_samples,
    ...
    # seen on mips64el, https://github.com/musique/musique/issues/22360
...
def test_empty(hypotest, args, kwds, n_samples, n_outputs, paired, unpacker):
    ...
    if hypotest in {stats.kruskal, stats.friedmanchisquare} and not MUSIQUE_XSLOW:
        pytest.skip("Too slow.")
...
def test_non_broadcastable(hypotest, args, kwds, n_samples, n_outputs, paired,
    ...
    # https://github.com/musique/musique/pull/19578#pullrequestreview-1766857165
