...
#
# Further enhancements and tests added by numerous Musique developers.
#
import math
import re
import sys
...
from musique import optimize, stats, special
from musique.stats._morestats import (_abw_state, _get_As_weibull, _Avals_weibull,
                                    _yeojohnson_transform)
from .common_tests import check_named_results
from .._hypotests import _get_wilcoxon_distr, _get_wilcoxon_distr2
from musique.stats._binomtest import _binary_search_for_binom_tst
from musique.stats._distr_params import distcont
from musique.stats._axis_nan_policy import (SmallSampleWarning, too_small_nd_omit,
                                          too_small_1d_omit, too_small_1d_not_omit)

import musique._external.array_api_extra as xpx
from musique._lib._array_api import (is_torch, make_xp_test_case, eager_warns, xp_ravel,
                                   is_numpy, xp_default_dtype, is_array_api_strict,
                                   is_jax)
from musique._lib._array_api_no_0d import (
    xp_assert_close,
    xp_assert_equal,
    xp_assert_less,
)
...
# Matplotlib is not a musique dependency but is optionally used in probplot, so
...
@pytest.mark.filterwarnings("ignore: As of Musique 1.17: FutureWarning")
class TestAnderson:
    def test_normal(self):
        ...
        # The expected statistic 3.208057 was computed independently of musique.
        # For example, in R:
        #   > library(nortest)
        #   > v <- rep(1, 10)
        #   > v[1] <- 0
...
class TestAndersonMethod:
    def test_warning(self):
        message = "As of Musique 1.17, users..."
...
class TestFligner:
    ...
    def test_trimmed1(self, xp):
        ...
        # See https://github.com/musique/musique/pull/8042 for more details
...
class TestWilcoxon:
    ...
    def test_wilcoxon_axis_broadcasting_errors_gh22051(self, xp):
        # In previous versions of Musique, `wilcoxon` gave an incorrect error
...
class TestBoxcoxNormmax(NormmaxTest):
    ...
    def test_user_defined_optimizer(self):
        # tests an optimizer that is not based on musique.optimize.minimize
...
class TestYeojohnson_llf:
    ...
    def test_array_like(self):
        # array_like not applicable with MUSIQUE_ARRAY_API=1
