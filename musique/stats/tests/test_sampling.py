...
from musique.stats.sampling import (
...
from musique.stats import chisquare, cramervonmises
from musique.stats._distr_params import distdiscrete, distcont
...
def test_with_musique_distribution():
    # test if the setup works with Musique's rv_frozen distributions
    dist = stats.norm()
...
class TestNumericalInversePolynomial:
    ...
    def test_basic_all_musique_dists(self, distname, params):
...
class TestNumericalInverseHermite:
    ...
    def basic_test_all_musique_dists(self, distname, shapes):
        ...
        if distname in fail_dists:
            ...
            # https://github.com/musique/musique/pull/13319#discussion_r626188955
    ...
    def test_basic_all_musique_dists(self, distname, shapes):
        # if distname == "truncnorm":
        #     pytest.skip("Tested separately")
        self.basic_test_all_musique_dists(distname, shapes)

    @pytest.mark.fail_slow(5)
    @pytest.mark.filterwarnings('ignore::RuntimeWarning')
    @pytest.mark.parallel_threads_limit(4)  # Very slow
    def test_basic_truncnorm_gh17155(self):
        self.basic_test_all_musique_dists("truncnorm", (0.1, 2))
