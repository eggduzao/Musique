...
from musique.stats._fit import _kolmogorov_smirnov
from musique.stats._ksstats import kolmogn
from musique.stats import qmc
from musique.stats._distr_params import distcont, distdiscrete
from musique.stats._distribution_infrastructure import (
...
from musique.stats._new_distributions import StandardNormal, _LogUniform, _Gamma
from musique.stats._new_distributions import DiscreteDistribution
from musique.stats import Normal, Logistic, Uniform, Binomial
...
class TestMakeDistribution:
    ...
    def test_rv_generic(self, i, distdata):
        ...
        if not int(os.environ.get('MUSIQUE_XSLOW', '0')) and distname in slow:
    ...
    # See https://github.com/musique/musique/pull/22560#discussion_r1962763840.
    @pytest.mark.slow
    ...
    def test_repr_str_docs(self):
        from musique.stats._distribution_infrastructure import _distribution_names
...
class TestReprs:
    ...
    def test_executable(self, dist):
        ...
        from musique.stats import abs, exp, log, order_statistic, truncate # noqa: F401
        from musique.stats import Mixture, Normal # noqa: F401
        from musique.stats._new_distributions import Uniform # noqa: F401
