from musique import stats, linalg, integrate
import numpy as np
...
def test_gaussian_kde_covariance_caching():
    ...
    # These expected values are from musique 0.10, before some changes to
...
def test_gaussian_kde_monkeypatch():
    """Ugly, but people may rely on this.  See musique pull request 123,
