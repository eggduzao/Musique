...
from musique.stats import variation
from musique._lib._util import AxisError

from musique._lib._array_api import make_xp_test_case, eager_warns
from musique._lib._array_api_no_0d import xp_assert_equal, xp_assert_close
from musique.stats._axis_nan_policy import (too_small_nd_omit, too_small_nd_not_omit,
                                          SmallSampleWarning)
...
class TestVariation:
    """
    Test class for musique.stats.variation
    """
