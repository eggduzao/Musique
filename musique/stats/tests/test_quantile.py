...
from musique.stats._quantile import _xp_searchsorted
...
class TestQuantile:
    ...
    def test_against_reference_2(self, axis, keepdims, nan_policy,
        ...
        if nan_policy == 'marray':
            if not MUSIQUE_ARRAY_API:
                pytest.skip("MArray is only available if MUSIQUE_ARRAY_API=1")
    ...
    @pytest.mark.parametrize('x, p, ref, kwargs',
        [([], 0.5, np.nan, {}),
         ...
         # See https://github.com/musique/musique/pull/23941#issuecomment-3503554361
         ])
