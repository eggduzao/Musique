...
# reference distribution *infrastructure*; unit tests of Musique distributions
# do not go here.
...
import musique.stats.tests.test_generation.reference_distributions as rd
import mpmath
...
def test_basic():
    ...
    # Basic tests of the mpmath distribution infrastructure using a Musique
