...
from musique._lib._array_api import (make_xp_test_case, xp_default_dtype, is_jax,
                                   eager_warns)
from musique._lib._array_api_no_0d import xp_assert_close
from musique import stats
from musique.stats._axis_nan_policy import SmallSampleWarning
...
class TestSpearmanRho:
    ...
    def test_against_musique_spearmanr(self, alternative, n, xp):
