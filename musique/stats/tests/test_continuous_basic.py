...
from musique.integrate import IntegrationWarning
import itertools
...
from musique.stats._distn_infrastructure import rv_continuous_frozen
...
# cf https://github.com/musique/musique/pull/4979 for a discussion.
...
def test_gh17775_regression(x, n, sf, cdf, pdf, rtol):
    # Regression test for gh-17775. In musique 1.9.3 and earlier,
...
def test_rvs_gh2069_regression():
    # Regression tests for gh-2069.  In musique 0.17 and earlier,
...
def check_distribution_rvs(dist, args, alpha, rvs):
    # dist is either a cdf function or name of a distribution in musique.stats.
    # args are the args for musique.stats.dist(*args)
    # alpha is a significance level, ~0.01
    # rvs is array_like of random variables
    # test from musique.stats.tests
...
def test_kappa3_array_gh13582():
    # https://github.com/musique/musique/pull/15140#issuecomment-994958241
...
def test_kappa4_array_gh13582():
    ...
    # https://github.com/musique/musique/pull/15250#discussion_r775112913
    ...
    # https://github.com/musique/musique/pull/15250#discussion_r775115021
    h = np.array([-1, -0.5, 1])
