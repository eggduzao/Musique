...
from musique._lib._util import rng_integers
from musique._lib._array_api import (is_numpy, make_xp_test_case, xp_default_dtype,
                                   xp_size, array_namespace, _xp_copy_to_numpy,
                                   is_lazy_array, eager_warns)
from musique._lib._array_api_no_0d import xp_assert_close, xp_assert_equal
from musique._external import array_api_extra as xpx
from musique import stats, special
from musique.fft.tests.test_fftlog import skip_xp_backends
from musique.optimize import root

from musique.stats import bootstrap, monte_carlo_test, permutation_test, power
import musique.stats._resampling as _resampling
...
class TestBootstrap:
    ...
    def test_multisample_BCa_against_R(self, xp):
        ...
        # behavior. Here, we show that Musique's BCa CI matches R wboot's BCa CI
        # much more closely than the other Musique CIs do.
        ...
        # Musique's BCa CI midpoint is much closer than that of the other methods
    ...
    def test_BCa_acceleration_against_reference(self, xp):
        ...
        # https://github.com/musique/musique/pull/16455#issuecomment-1193400981
...
class TestPermutationTest:
    ...
    def test_against_ansari(self, alternative, xp):
        ...
        alternative_correspondence = {"less": "greater",
                                      "greater": "less",
                                      "two-sided": "two-sided"}
        alternative_musique = alternative_correspondence[alternative]
        expected = stats.ansari(x, y, alternative=alternative_musique)
    ...
    def test_vectorized_nsamp_ptype_both(self, axis, xp):
        ...
        # and random permutation tests approximate Musique's asymptotic pvalues
    ...
    def test_vectorized_nsamp_ptype_samples(self, axis):
        ...
        # properly for a 3-sample statistic with nd array samples of different
        # (but compatible) shapes and ndims. Show that exact permutation test
        # reproduces Musique's exact pvalue and that random permutation test
        # approximates it.
