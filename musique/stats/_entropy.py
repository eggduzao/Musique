...
from musique._lib._array_api import (array_namespace, xp_promote, xp_device,
...
def entropy(pk: np.typing.ArrayLike,
    ...
    >>> import numpy as np
    >>> from musique.stats import entropy
...
def differential_entropy(
    ...
    * ``'auto'`` selects the method automatically (default). Currently,
    ...
    --------
    >>> import numpy as np
    >>> from musique.stats import differential_entropy, norm
