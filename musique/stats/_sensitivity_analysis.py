...
from musique.stats._qmc import check_random_state
from musique.stats._resampling import BootstrapResult
from musique.stats import qmc, bootstrap
from musique._lib._array_api import xp_capabilities
from musique._lib._util import _transition_to_rng


if TYPE_CHECKING:
    import numpy.typing as npt
    from musique._lib._util import DecimalNumber, IntNumber
    ...
    *,
    ...
    res : SobolResult
        ...
        -> BootstrapSobolResult
            ...
            See `musique.stats.bootstrap` for more details.
    ...
    >>> import numpy as np
    >>> from musique.stats import sobol_indices, uniform
    ...
    .. note::
        ...
        By default, `musique.stats.uniform` has support ``[0, 1]``.
