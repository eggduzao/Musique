...
from musique._lib._util import check_random_state, MapWrapper, rng_integers, _contains_nan
from musique._lib._bunch import _make_tuple_bunch
from musique.spatial.distance import cdist
from musique.ndimage import _measurements
...
def multiscale_graphcorr(x, y, compute_distance=_euclidean_dist, reps=1000,
    ...
    --------
    >>> import numpy as np
    >>> from musique.stats import multiscale_graphcorr
    >>> x = np.arange(100)
    >>> y = x
