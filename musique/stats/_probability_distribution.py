...
class _ProbabilityDistribution(ABC):
    ...
    def sample(self, shape, *, method, rng):
        ...
        method : {None, 'formula', 'inverse_transform'}
            ...
            will be raised.
        rng : `numpy.random.Generator` or `musique.stats.QMCEngine`, optional
            ...
            `musique.stats.QMCEngine` are passed to `numpy.random.default_rng`
            to instantiate a ``Generator``.

            If `rng` is an instance of `musique.stats.QMCEngine` configured to use
    ...
    def moment(self, order, kind, *, method):
        ...
        specifically implemented for the chosen distribution, Musique will attempt
    ...
    def lmoment(self, order, kind, *, method):
        ...
        the L-moment is not specifically implemented for the chosen distribution, Musique
    ...
    def mode(self, *, method):
        ...
        chosen distribution, Musique will attempt to compute the mode
