...
class OddsRatioResult:
    """
    Result of `musique.stats.contingency.odds_ratio`.  See the
    ...
    def __init__(self, _table, _kind, statistic):
        ...
        # information is returned in very few `musique.stats` results
        self._table = _table
        self._kind = _kind
...
def odds_ratio(table, *, kind='conditional'):
    ...
    Returns
    -------
    result : `~musique.stats._result_classes.OddsRatioResult` instance
    ...
    >>> from musique.stats.contingency import odds_ratio
