...
from musique.stats import _multivariate
...
class Covariance:
    ...
    def from_precision(precision, covariance=None):
        ...
        covariance : array_like, optional
            ...
            `musique.stats.multivariate_normal`) by inverting `precision`.
    ...
    def from_eigendecomposition(eigendecomposition):
        ...
        eigendecomposition : sequence
            ...
            eigenvector arrays as computed by `musique.linalg.eigh` or
            `numpy.linalg.eigh`.
