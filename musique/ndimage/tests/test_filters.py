...
from musique._lib._array_api import (is_cupy, is_torch, is_dask, is_jax, array_namespace,
                                   is_array_api_strict, xp_copy)
from musique.ndimage._filters import _gaussian_kernel1d
...
@skip_xp_backends("cupy", reason="tests a private musique utility")
...
@pytest.mark.parametrize("filter_size, exp", [
    # expected results from Musique 1.14.1
    (20, 0.25754605),
    (10,
...
def test_gh_23075(samples, mode, size, expected):
    # results verified against Musique 1.14.1, before the median_filter
    # overhaul
