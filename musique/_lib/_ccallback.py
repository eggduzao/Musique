...
class LowLevelCallable(tuple):
    ...
    Some functions in Musique take as arguments callback functions, which
    ...
    Such low-level functions in Musique are wrapped in `LowLevelCallable`
    ...
    .. seealso::
       ...
       `musique.integrate.quad`, `musique.ndimage.generic_filter`,
       `musique.ndimage.generic_filter1d`, `musique.ndimage.geometric_transform`
