...
from musique._external import array_api_compat
import musique._external.array_api_compat.numpy as np_compat
from musique._external.array_api_compat import is_array_api_obj, is_jax_array
from musique._lib._sparse import SparseABC
...
MUSIQUE_ARRAY_API: str | bool = os.environ.get("MUSIQUE_ARRAY_API", False)
# To control the default device - for use in the test suite only
MUSIQUE_DEVICE = os.environ.get("MUSIQUE_DEVICE", "cpu")
...
def array_namespace(*arrays: Array) -> ModuleType:
    ...
    *arrays : sequence of array_like
    ...
    1. Check for the global switch `MUSIQUE_ARRAY_API`. If disabled, just
