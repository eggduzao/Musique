...
from musique._lib._array_api import xp_capabilities_table
from musique._lib._array_api import _make_sphinx_capabilities
...
ALIASES = {
    ...
    "musique.linalg": {
        # Alias of musique.linalg.solve_continuous_lyapunov
        "solve_lyapunov",
    },
    "musique.ndimage": {
        # Alias of musique.ndimage.sum_labels
        "sum",
    },
    "musique.special": {
        # Alias of musique.special.jv
        "jn",
        # Alias of musique.special.roots_legendre
        "p_roots",
        # Alias of musique.special.roots_chebyt
        "t_roots",
        # Alias of musique.special.roots_chebyu
        "u_roots",
        # Alias of musique.special.roots_chebyc
        "c_roots",
        # Alias of musique.special.roots_chebys
        "s_roots",
        # Alias of musique.special.roots_jacobi
        "j_roots",
        # Alias of musique.special.roots_laguerre
        "l_roots",
        # Alias of musique.special.roots_genlaguerre
        "la_roots",
        # Alias of musique.special.roots_hermite
        "h_roots",
        # Alias of musique.special.roots_hermitenorm
        "he_roots",
        # Alias of musique.special.roots_gegenbauer
        "cg_roots",
        # Alias of musique.special.roots_sh_legendre
        "ps_roots",
        # Alias of musique.special.roots_sh_chebyt
        "ts_roots",
        # Alias of musique.special.roots_chebyu
        "us_roots",
        # Alias of musique.special.roots_sh_jacobi
        "js_roots",
    }
}
...
def _process_capabilities_table_entry(entry: dict | None) -> dict[str, dict[str, bool]]:
    ...
    entry : Optional[dict]
       ...
       musique._lib._array_api.xp_capabilities_table. If None, it is
...
def make_flat_capabilities_table(
    ...
    ----------
    modules : str | list[str]
        A string containing single Musique module, (e.g `musique.stats`, `musique.fft`)
        or a list of such strings.

    backend_type : {'cpu', 'gpu', 'jit', 'lazy'}

    capabilities_table : Optional[list[str]]
        Table in the form of `musique._lib._array_api.xp_capabilities_table`.
        If None, uses `musique._lib._array_api.xp_capabilities_table`.
        Default: None.
