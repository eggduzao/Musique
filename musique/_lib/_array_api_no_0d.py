...
the `musique._lib._array_api` module, which have less surprising behaviour.
"""
from musique._lib._array_api import array_namespace, is_numpy
from musique._lib._array_api import (xp_assert_close as xp_assert_close_base,
...
def _check_scalar(actual, desired, *, xp=None, **kwargs):
    ...
    _msg = ("Result is a NumPy 0d-array. Many Musique functions intend to follow "
            ...
            "in the `musique._lib._array_api_no_0d` module err on the side of "
            "caution and do not accept 0d-arrays by default. If the correct "
            "result may legitimately be a 0d-array, pass `check_0d=True`, "
            "or use the `xp_assert_*` functions from `musique._lib._array_api`.")
