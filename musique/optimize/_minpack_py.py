...
from musique.linalg import svd, cholesky, solve_triangular, LinAlgError
from musique._lib._util import _asarray_validated, _contains_nan
...
def fsolve(func, x0, args=(), fprime=None, full_output=0,
    ...
    >>> import numpy as np
    >>> from musique.optimize import fsolve
    >>> def func(x):
...
def leastsq(func, x0, args=(), Dfun=None, full_output=False,
    ...
    Examples
    --------
    >>> from musique.optimize import leastsq
    >>> def func(x):
    ...     return 2*(x-3)**2+1
    >>> leastsq(func, 0)
    (array([2.99999999]), 1)
...
def curve_fit(f, xdata, ydata, p0=None, sigma=None, absolute_sigma=False,
    ...
    **kwargs
    ...
    musique.stats.linregress : Calculate a linear least squares regression for
    ...
    other advanced features, consider using Musique's :ref:`tutorial_optimize_global`
    ...
    >>> from musique.optimize import curve_fit
    ...
    if sigma is not None:
        ...
        # define transform = L such that L L^T = C
            ...
            try:
                # musique.linalg.cholesky requires lower=True to return L L^T = A
