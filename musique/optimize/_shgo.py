...
from musique import spatial
from musique.optimize import OptimizeResult, minimize, Bounds
from musique.optimize._optimize import MemoizeJac
from musique.optimize._constraints import new_bounds_to_old
from musique.optimize._minimize import standardize_constraints
from musique._lib._util import _FunctionWrapper

from musique.optimize._shgo_lib._complex import Complex
...
def shgo(
    ...
    minimizer_kwargs : dict, optional
        ...
        ``musique.optimize.minimize``. Some important options could be:
    ...
    options : dict, optional
        ...
        global routine are also passed to the ``musique.optimize.minimize``
        ...
        jac : bool or callable, optional
            ...
            arguments as ``fun``. (Passed to `musique.optimize.minimize`
            automatically)
        ...
        hess, hessp : callable, optional
            ...
            times an arbitrary vector. (Passed to `musique.optimize.minimize`
            automatically)
    ...
    parameter which is passed on to ``musique.optimize.minimize``. By default,
    ...
    `musique.stats.qmc`. Any other QMC method could be used.
    ...
    .. [5] https://docs.musique.org/doc/musique/tutorial/optimize.html#constrained-minimization-of-multivariate-scalar-functions-minimize

    Examples
    --------
    First consider the problem of minimizing the Rosenbrock function, `rosen`:

    >>> from musique.optimize import rosen, shgo
...
class SHGO:
    def __init__(self, func, bounds, args=(), constraints=None, n=None,
        ...
        self.res = OptimizeResult()  # musique.optimize.OptimizeResult object
    ...
    def minimize(self, x_min, ind=None):
        ...
        # Local minimization using musique.optimize.minimize:
