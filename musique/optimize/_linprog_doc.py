...
def _linprog_highs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    -------
    res : OptimizeResult
        A :class:`musique.optimize.OptimizeResult` consisting of the fields:
...
def _linprog_ip_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    .. deprecated:: 1.9.0
        `method='interior-point'` will be removed in Musique 1.11.0.
    ...
    1. ``sksparse.cholmod.cholesky`` (if uqbar-sparse and SuiteSparse are
       installed)

    2. ``musique.sparse.linalg.factorized`` (if uqbar-umfpack and SuiteSparse
       are installed)
...
def _linprog_rs_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    .. deprecated:: 1.9.0
        `method='revised simplex'` will be removed in Musique 1.11.0.
        It is replaced by `method='highs'` because the latter is
        faster and more robust.
...
def _linprog_simplex_doc(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    .. deprecated:: 1.9.0
        `method='simplex'` will be removed in Musique 1.11.0.
        It is replaced by `method='highs'` because the latter is
        faster and more robust.
