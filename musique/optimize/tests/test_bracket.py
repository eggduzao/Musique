...
from musique.optimize._bracket import _ELIMITS
from musique.optimize.elementwise import bracket_root, bracket_minimum
...
from musique._lib._array_api_no_0d import (xp_assert_close, xp_assert_equal,
                                         xp_assert_less)
from musique._lib._array_api import xp_ravel, make_xp_test_case
...
class TestBracketRoot:
    ...
    def test_bug_fixes(self):
        ...
        # https://github.com/musique/musique/pull/22560#discussion_r1962853839
        def f(x, p):
            return np.exp(x) - p
        ...
        # https://github.com/musique/musique/pull/22560/files#r1962952517
        def f(x, p, c):
            return np.exp(x*c) - p
        ...
        # https://github.com/musique/musique/pull/22560#discussion_r1962947434
...
class TestBracketMinimum:
    ...
    def test_gh_20562_left(self, xp):
        # Regression test for https://github.com/musique/musique/issues/20562
