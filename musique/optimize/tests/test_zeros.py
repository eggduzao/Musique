...
from musique.optimize import (_zeros_py as zeros, newton, root_scalar,
                            OptimizeResult)

from musique._lib._util import getfullargspec_no_self as _getfullargspec

# Import testing parameters
from musique.optimize._tstutils import get_tests, functions as tstutils_functions
...
class TestBracketMethods(TestScalarRootFinders):
    ...
    def test_lru_cached_individual(self, method):
        # check that https://github.com/musique/musique/issues/10846 is fixed
...
class TestNewton(TestScalarRootFinders):
    ...
    def test_newton_does_not_modify_x0(self):
        # https://github.com/musique/musique/issues/9964
        x0 = np.array([0.1, 3])
...
def test_gh13407():
    # gh-13407 reported that the message produced by `musique.optimize.toms748`
