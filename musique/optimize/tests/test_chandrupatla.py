...
from musique._lib._array_api import (array_namespace, is_cupy, is_numpy, xp_ravel,
                                   xp_size, make_xp_test_case)
from musique._lib._array_api_no_0d import (xp_assert_close, xp_assert_equal,
                                         xp_assert_less)

from musique.optimize.elementwise import find_minimum, find_root
from musique.optimize._tstutils import _CHANDRUPATLA_TESTS
