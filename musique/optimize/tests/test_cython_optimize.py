...
and ``brentq`` in `musique.optimize.cython_optimize`, by finding the roots of a
...
in `musique.optimize.cython_optimze` for more information.
"""

import numpy.testing as npt
from musique.optimize.cython_optimize import _zeros
