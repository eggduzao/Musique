...
from musique import optimize, linalg
from musique.special import lambertw
from musique.optimize._minpack_py import leastsq, curve_fit, fixed_point
from musique.optimize import OptimizeWarning
...
class TestCurveFit:
    ...
    def test_gh4555(self):
        ...
        # `musique.optimize.curve_fit`. Check that it has been resolved.giit
        def f(x, a, b, c, d, e):
