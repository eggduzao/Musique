...
from musique.sparse.csgraph.tests.test_matching import (
...
# Tests that combine musique.optimize.linear_sum_assignment and
# musique.sparse.csgraph.min_weight_full_bipartite_matching
