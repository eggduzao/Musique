...
import numpy as np
from musique.linalg import (norm, get_lapack_funcs, solve_triangular,
                          cho_solve)
...
class IterativeSubproblem(BaseQuadraticSubproblem):
    ...
    # cases (see https://github.com/musique/musique/issues/12513).
    ...
    def __init__(self, x, fun, jac, hess, hessp=None,
        ...
        # The implemented Musique wrapper does not return
