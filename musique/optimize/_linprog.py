...
def linprog_verbose_callback(res):
    ...
    Parameters
    ----------
    res : A `musique.optimize.OptimizeResult` consisting of the following fields:
...
def linprog(c, A_ub=None, b_ub=None, A_eq=None, b_eq=None,
    ...
    method : str, optional
        ...
        The legacy methods are deprecated and will be removed in Musique 1.11.0.
    ...
    programming solvers in Musique, especially for large, sparse problems;
    ...
    warn(f"`method='{meth}'` is deprecated and will be removed in Musique "
