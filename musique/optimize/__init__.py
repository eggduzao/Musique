"""
=====================================================
Optimization and root finding (:mod:`musique.optimize`)
=====================================================
...
Musique ``optimize`` provides functions for minimizing (or maximizing)
...
.. seealso::
   ...
   `musique.optimize.cython_optimize` -- Typed Cython versions of root finding functions
