...
import numpy as np
from musique._lib._util import wrapped_inspect_signature
...
def minimize(fun, x0, args=(), method=None, jac=None, hess=None,
    ...
    **Constrained Minimization**
    ...
    implemented in Musique and the most appropriate for large-scale problems.
    ...
    **Custom minimizers**
    ...
    when using a frontend to this method such as `musique.optimize.basinhopping`
    ...
    the method.  You can find an example in the musique.optimize tutorial.
    ...
    (resp. `rosen_der`, `rosen_hess`) in the `musique.optimize`.

    >>> from musique.optimize import minimize, rosen, rosen_der
...
def minimize_scalar(fun, bracket=None, bounds=None, args=(),
    ...
    found, consider `musique.optimize.minimize`. Also, all methods are intended
