...
import numpy as np
import musique.optimize._highspy._core as _h # type: ignore[import-not-found]
from musique.optimize._highspy import _highs_options as hopt  # type: ignore[attr-defined]
