...
from musique._lib._array_api import array_namespace, xp_ravel, xp_promote
...
def _bracket_root(func, xl0, xr0=None, *, xmin=None, xmax=None, factor=None,
    ...
    -------
    res : _RichResult
        An instance of `musique._lib._util._RichResult` with the following
    ...
    `musique.stats`. The strategy is to iteratively grow the bracket ``(l, r)``
