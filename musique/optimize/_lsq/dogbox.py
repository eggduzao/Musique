...
Jacobian matrices) or by iterative procedure `musique.sparse.linalg.lsmr` (for
...
from musique.sparse.linalg import LinearOperator, aslinearoperator, lsmr
from musique.optimize import OptimizeResult
from musique._lib._util import _call_callback_maybe_halt
