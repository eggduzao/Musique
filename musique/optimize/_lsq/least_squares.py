...
from musique.optimize import _minpack, OptimizeResult
from musique.optimize._differentiable_functions import VectorFunction
from musique.optimize._numdiff import group_columns
from musique.optimize._minimize import Bounds
from musique._lib._sparse import issparse
from musique._lib._array_api import array_namespace
from musique._lib._util import _workers_wrapper
...
from musique.optimize._optimize import _wrap_callback
...
def least_squares(
    ...
    jac : {'2-point', '3-point', 'cs', callable}, optional
        ...
        a `musique.sparse.linalg.LinearOperator`.
    ...
    tr_solver : {None, 'exact', 'lsmr'}, optional
        ...
        * 'lsmr' is suitable for problems with sparse and large Jacobian
          ...
          `musique.sparse.linalg.lsmr` for finding a solution of a linear
    ...
    tr_options : dict, optional
        ...
        * ``tr_solver='lsmr'``: options for `musique.sparse.linalg.lsmr`.
    ...
    callback : None or callable, optional
        ...
        `intermediate_result is a `musique.optimize.OptimizeResult`
    ...
    Gauss-Newton solution delivered by `musique.sparse.linalg.lsmr`. When no
    ...
    dense Jacobians or approximately by `musique.sparse.linalg.lsmr` for large
    ...
    >>> from musique.sparse import lil_array
