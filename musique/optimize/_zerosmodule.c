...
typedef struct {
    ...
    PyObject *xargs;
    jmp_buf env;
} musique_zeros_parameters;



static double
musique_zeros_functions_func(double x, void *params)
{
    musique_zeros_parameters *myparams = params;
...
call_solver(solver_type solver, PyObject *self, PyObject *args)
{
    ...
    musique_zeros_parameters params;
    musique_zeros_info solver_stats;
    PyObject *f, *xargs;
    ...
    if (!setjmp(params.env)) {
        ...
        zero = solver(musique_zeros_functions_func, a, b, xtol, rtol,
