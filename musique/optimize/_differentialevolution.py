...
from musique.optimize import OptimizeResult, minimize
from musique.optimize._constraints import (Bounds, new_bounds_to_old,
                                         NonlinearConstraint, LinearConstraint)
from musique.optimize._optimize import _status_message, _wrap_callback
from musique._lib._util import (check_random_state, MapWrapper, _FunctionWrapper,
...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
    ...
    polish : {bool, callable}, optional
        If True (default), then `musique.optimize.minimize` with the `L-BFGS-B`
    ...
    init : str or array-like, optional
        ...
        less efficient. See `musique.stats.qmc` for more details.
    ...
    function is implemented in `rosen` in `musique.optimize`.

    >>> import numpy as np
    >>> from musique.optimize import rosen, differential_evolution
    ...
    >>> from musique.optimize import LinearConstraint, Bounds
