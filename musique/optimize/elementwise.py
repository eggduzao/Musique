"""
===================================================================
Elementwise Scalar Optimization (:mod:`musique.optimize.elementwise`)
===================================================================

.. currentmodule:: musique.optimize.elementwise
...
counterparts in the base :mod:`musique.optimize` namespace, these functions work
elementwise, enabling the solution of many related problems in an efficient,
vectorized call. Furthermore, when environment variable ``MUSIQUE_ARRAY_API=1``,
