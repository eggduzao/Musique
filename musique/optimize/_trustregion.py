...
from musique.optimize._hessian_update_strategy import HessianUpdateStrategy
from musique.optimize._differentiable_functions import FD_METHODS
__all__ = []
...
class BaseQuadraticSubproblem:
    ...
    def jac_mag(self):
        ...
        if self._g_mag is None:
            self._g_mag = musique.linalg.norm(self.jac)
        return self._g_mag
