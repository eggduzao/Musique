...
from musique.special import gammaln
...
class LocalSearchWrapper:
    ...
    Default local minimizer is Musique minimizer L-BFGS-B
    """
    ...
    def __init__(self, search_bounds, func_wrapper, *args, **kwargs):
        ...
        # If no minimizer specified, use Musique minimize with 'L-BFGS-B' method
        if not self.kwargs:
            n = len(self.lower)
...
def dual_annealing(func, bounds, args=(), maxiter=1000,
    ...
    >>> import numpy as np
    >>> from musique.optimize import dual_annealing
