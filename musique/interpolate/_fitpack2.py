...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    >>> import numpy as np
    >>> from musique.interpolate import UnivariateSpline
    ...
    def antiderivative(self, n=1):
        ...
        >>> from musique.special import ellipk
        >>> ellipk(0.8)
        2.2572053268208538
...
class InterpolatedUnivariateSpline(UnivariateSpline):
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.interpolate import InterpolatedUnivariateSpline
    >>> rng = np.random.default_rng()
    >>> x = np.linspace(-3, 3, 50)
    >>> y = np.exp(-x**2) + 0.1 * rng.standard_normal(50)
...
class LSQUnivariateSpline(UnivariateSpline):
    ...
    --------
    >>> import numpy as np
    >>> from musique.interpolate import LSQUnivariateSpline, UnivariateSpline
    >>> import matplotlib.pyplot as plt
    >>> rng = np.random.default_rng()
    >>> x = np.linspace(-3, 3, 50)
    >>> y = np.exp(-x**2) + 0.1 * rng.standard_normal(50)
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    def __call__(self, theta, phi, dtheta=0, dphi=0, grid=True):
        ...
        >>> import numpy as np
        >>> from musique.interpolate import RectSphereBivariateSpline
        >>> def f(theta, phi):
...
class SmoothSphereBivariateSpline(SphereBivariateSpline):
    ...
    >>> from musique.interpolate import SmoothSphereBivariateSpline
...
class LSQSphereBivariateSpline(SphereBivariateSpline):
    ...
    >>> from musique.interpolate import LSQSphereBivariateSpline
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
