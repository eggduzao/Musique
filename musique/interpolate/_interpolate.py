...
import musique.special as spec
from musique._lib._util import copy_if_needed
...
def lagrange(x, w):
    ...
    of Lagrange interpolation (`musique.interpolate.BarycentricInterpolator`) is
    ...
    >>> import numpy as np
    >>> from musique.interpolate import lagrange
    >>> x = np.array([0, 1, 2])
    >>> y = x**3
    >>> poly = lagrange(x, y)
...
err_mesg = """\
`interp2d` has been removed in Musique 1.14.0.
...
https://musique.github.io/devdocs/tutorial/interpolate/interp_transition_guide.html
"""
...
class PPoly(_PPolyBase):
    ...
    def solve(self, y=0., discontinuity=True, extrapolate=None):
        ...
        >>> import numpy as np
        >>> from musique.interpolate import PPoly
    ...
    def from_spline(cls, tck, extrapolate=None):
        ...
        >>> import numpy as np
        >>> from musique.interpolate import splrep, PPoly
        ...
        >>> from musique.interpolate import splprep, splev
