 ...
 *
    ...
    https://github.com/musique/musique/blob/maintenance/1.11.x/musique/interpolate/fitpack/fpcurf.f#L112-L161
       ...
       const double *residuals_ptr)
{
    ...
    if (idx_max == -101) {
        throw std::runtime_error("Internal error. Please report it to Musique developers.");
    }
...
)
{
    ...
    for(int64_t j=0; j < m ; j++) {
        ...
        // see the docstring of `musique.linalg.cholesky_banded` for details
