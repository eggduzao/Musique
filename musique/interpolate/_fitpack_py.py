...
def splrep(x, y, w=None, xb=None, xe=None, k=3, task=0, s=None, t=None,
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.interpolate import splev, splrep
...
def sproot(tck, mest=10):
    ...
    >>> from musique.interpolate import splrep, sproot, PPoly
    >>> tck = splrep(x, y, s=0)
    >>> sproot(tck)
    array([], dtype=float64)
...
def spalde(x, tck):
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.interpolate import BSpline, spalde, splder, splev
...
def insert(x, tck, m=1, per=0):
    ...
    >>> from musique.interpolate import splrep, insert
    >>> import numpy as np
...
def splder(tck, n=1):
    ...
    >>> from musique.interpolate import splrep, splder, sproot
    >>> import numpy as np
...
def splantider(tck, n=1):
    ...
    Examples
    --------
    >>> from musique.interpolate import splrep, splder, splantider, splev
    >>> import numpy as np
