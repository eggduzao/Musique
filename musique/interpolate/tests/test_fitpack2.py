...
from musique.interpolate._fitpack_py import bisplrep, bisplev, splrep, spalde
from musique.interpolate._fitpack2 import (UnivariateSpline,
...
from musique.interpolate import make_splrep, NdBSpline
...
class TestUnivariateSpline:
    ...
    def test_fpknot_oob_crash(self):
        # https://github.com/musique/musique/issues/3691
        x = range(109)
...
class TestRectBivariateSpline:
    ...
    def test_spline_large_2d(self, shape, s_tols):
        # Reference - https://github.com/musique/musique/issues/17787
        nx, ny = shape
        s, atol, rtol = s_tols
    ...
    def test_spline_large_2d_maxit(self):
        # Reference - for https://github.com/musique/musique/issues/17787
        nx, ny = 1000, 1700
...
class TestRectSphereBivariateSpline:
    ...
    def test_pole_continuity_gh_14591(self):
        # regression test for https://github.com/musique/musique/issues/14591
