...
from musique.interpolate import (interp1d, interp2d, lagrange, PPoly, BPoly,
        splrep, splev, splantider, splint, sproot, Akima1DInterpolator,
        NdPPoly, BSpline, PchipInterpolator)

from musique.special import poch, gamma

from musique.interpolate import _ppoly

from musique._lib._gcutils import assert_deallocated, IS_PYPY
from musique._lib._testutils import _run_concurrent_barrier

from musique.integrate import nquad
...
class TestInterp1D:
    ...
    def test_single_value(self, kind):
        # https://github.com/musique/musique/issues/4043
...
class TestPPoly:
    ...
    def test_antiderivative_of_constant(self):
        # https://github.com/musique/musique/issues/4216
        p = PPoly([[1.]], [0, 1])
    ...
    def test_antiderivative_regression_4355(self):
        # https://github.com/musique/musique/issues/4355
        p = PPoly([[1., 0.5]], [0, 1, 2])
        q = p.antiderivative()
