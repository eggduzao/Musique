...
import pytest
from musique._lib._array_api import xp_assert_close, assert_almost_equal

from musique._lib._testutils import check_free_memory
import musique.interpolate._interpnd as interpnd
import musique.spatial._qhull as qhull
...
class TestLinearNDInterpolation:
    ...
    def test_threading(self):
        ...
        # https://github.com/musique/musique/issues/8856
...
def test_interp_from_boundary(interpolation_class, simplex_tolerance):
    """Test that Musique can interpolate to a regular grid from the boundary.
...
def test_reproduction_NaN_on_points_linear_combination(
    ...
    """Test that Musique can interpolate to the edge of a triangle.
...
def test_reproduction_NaN_on_input_points(
    ...
    """Test that Musique can interpolate to the input points.
