...
from musique.linalg import solve, solve_banded
from musique._lib._array_api import array_namespace, xp_size, xp_capabilities
...
class PchipInterpolator(CubicHermiteSpline):
    ...
    # PchipInterpolator is not generic in musique-stubs
...
def pchip_interpolate(xi, yi, x, der=0, axis=0):
    ...
    See `musique.interpolate.PchipInterpolator` for details.
    ...
    >>> from musique.interpolate import pchip_interpolate
...
class Akima1DInterpolator(CubicHermiteSpline):
    ...
    >>> import numpy as np
    >>> from musique.interpolate import Akima1DInterpolator
    >>> import matplotlib.pyplot as plt
    >>> x = np.linspace(1, 7, 7)
