...
from musique._lib._array_api import array_namespace, xp_capabilities
...
def _check_points(points):
    ...
    for i, p in enumerate(points):
        ...
        # see https://github.com/musique/musique/pull/17230
        ...
        # see https://github.com/musique/musique/issues/17716
...
class RegularGridInterpolator:
    ...
    solver : callable, optional
        ...
        Default is the iterative solver `musique.sparse.linalg.gcrotmk`.
    ...
    **Choosing a solver for spline methods**
    ...
    choose between the direct solver (`musique.sparse.linalg.spsolve`) or
    iterative solvers from `musique.sparse.linalg`. You may need to supply
    ...
    `musique.sparse.linalg` documentation for the full list of available options.
    ...
    **Evaluate a function on the points of a 3-D grid**
    ...
    >>> from musique.interpolate import RegularGridInterpolator
    >>> import numpy as np
    >>> def f(x, y, z):
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    musique.ndimage.map_coordinates : interpolation on grids with equal spacing
...
def interpn(points, values, xi, method="linear", bounds_error=True,
    ...
    >>> import numpy as np
    >>> from musique.interpolate import interpn
