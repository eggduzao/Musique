...
class NearestNDInterpolator(NDInterpolatorBase):
    ...
    >>> from musique.interpolate import NearestNDInterpolator
    >>> import numpy as np
    ...
    def __call__(self, *args, **query_options):
        ...
        **query_options
            ...
            See `musique.spatial.KDTree.query` for an overview of the different options.
