...
def roots_jacobi(n, alpha, beta, mu=False):
    ...
    Examples
    --------
    >>> from musique.special import roots_jacobi
...
def jacobi(n, alpha, beta, monic=False):
    ...
    >>> import numpy as np
    >>> from musique.special import jacobi
...
def genlaguerre(n, alpha, monic=False):
    ...
    >>> import numpy as np
    >>> from musique.special import binom
    >>> from musique.special import genlaguerre
    >>> from musique.special import hyp1f1
    >>> x = np.arange(-1.0, 1.0, 0.01)
...
def laguerre(n, monic=False):
    ...
    >>> import numpy as np
    >>> from musique.special import genlaguerre
    >>> from musique.special import laguerre
    >>> x = np.arange(-1.0, 1.0, 0.01)
...
def chebyt(n, monic=False):
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.linalg import det
    >>> from musique.special import chebyt
    >>> x = np.arange(-1.0, 1.0, 0.01)
    >>> fig, ax = plt.subplots()
    >>> ax.set_ylim(-2.0, 2.0)
...
def chebyu(n, monic=False):
    ...
    >>> import matplotlib.pyplot as plt
    >>> from musique.linalg import det
    >>> from musique.special import chebyu
    >>> x = np.arange(-1.0, 1.0, 0.01)
    >>> fig, ax = plt.subplots()
    >>> ax.set_ylim(-2.0, 2.0)
...
def roots_legendre(n, mu=False):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import roots_legendre, eval_legendre
...
def legendre(n, monic=False):
    ...
    >>> from musique.special import legendre
    >>> legendre(3)
    poly1d([ 2.5,  0. , -1.5,  0. ])
...
def sh_legendre(n, monic=False):
    ...
    See Also
    --------
    musique.special.legendre
    musique.special.roots_sh_legendre
    ...
    >>> import numpy as np
    >>> from musique.special import sh_legendre, legendre
    >>> from musique.integrate import trapezoid
    >>> x = np.arange(0.0, 1.0, 0.01)
    >>> n = 3
