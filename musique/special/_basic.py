...
def jnyn_zeros(n, nt):
    ...
    >>> from musique.special import jnyn_zeros
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import jnyn_zeros, jvp, jn, yvp, yn
    >>> jn_roots, jnp_roots, yn_roots, ynp_roots = jnyn_zeros(1, 3)
    >>> fig, ax = plt.subplots()
    >>> xmax= 11
...
def jn_zeros(n, nt):
    ...
    >>> from musique.special import jn_zeros
    >>> jn_zeros(3, 4)
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import jn, jn_zeros
...
def jnp_zeros(n, nt):
    ...
    >>> from musique.special import jnp_zeros
    >>> jnp_zeros(2, 4)
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import jn, jnp_zeros, jvp
...
def yn_zeros(n, nt):
    ...
    >>> from musique.special import yn_zeros
    >>> yn_zeros(2, 4)
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import yn, yn_zeros
    >>> xmin = 2
    >>> xmax = 15
    >>> x = np.linspace(xmin, xmax, 500)
    >>> fig, ax = plt.subplots()
...
def ynp_zeros(n, nt):
    ...
    >>> from musique.special import ynp_zeros
    >>> ynp_zeros(0, 4)
    ...
    >>> import numpy as np
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import yn, ynp_zeros, yvp
    >>> zeros = ynp_zeros(0, 4)
    >>> xmax = 13
    >>> x = np.linspace(0, xmax, 500)
    >>> fig, ax = plt.subplots()
...
def y0_zeros(nt, complex=False):
    ...
    >>> import numpy as np
    >>> from musique.special import y0_zeros
...
def y1_zeros(nt, complex=False):
    ...
    >>> import numpy as np
    >>> from musique.special import y1_zeros
...
def y1p_zeros(nt, complex=False):
    ...
    >>> import numpy as np
    >>> from musique.special import y1p_zeros
    ...
    >>> import matplotlib.pyplot as plt
    >>> from musique.special import y1, yvp
...
def jvp(v, z, n=1):
    ...
    >>> from musique.special import jvp
...
def yvp(v, z, n=1):
    ...
    >>> from musique.special import yvp
...
def kvp(v, z, n=1):
    ...
    >>> from musique.special import kvp
...
def ivp(v, z, n=1):
    ...
    >>> from musique.special import ivp
...
def h1vp(v, z, n=1):
    ...
    >>> from musique.special import h1vp
...
def h2vp(v, z, n=1):
    ...
    >>> from musique.special import h2vp
...
def bernoulli(n):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import bernoulli, zeta
    >>> bernoulli(4)
...
def euler(n):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import euler
    >>> euler(6)
...
def lqn(n, z):
    ...
    >>> import numpy as np
    >>> from musique.special import lqn
    >>> import matplotlib.pyplot as plt
...
def berp_zeros(nt):
    ...
    >>> from musique.special import berp_zeros
    >>> berp_zeros(5)
...
def comb(N, k, *, exact=False, repetition=False):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import comb
    >>> k = np.array([3, 4])
    >>> n = np.array([10, 10])
...
def perm(N, k, exact=False):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import perm
    >>> k = np.array([3, 4])
    >>> n = np.array([10, 10])
    >>> perm(n, k)
    array([  720.,  5040.])
...
def factorial(n, exact=False, extend="zero"):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import factorial
    >>> arr = np.array([3, 4, 5])
...
def factorial2(n, exact=False, extend="zero"):
    ...
    * 3 * 1``.  It can be approximated numerically as::
    ...
    Examples
    --------
    >>> from musique.special import factorial2
...
def factorialk(n, k, exact=False, extend="zero"):
    ...
    Examples
    --------
    >>> from musique.special import factorialk
...
def stirling2(N, K, *, exact=False):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import stirling2
    >>> k = np.array([3, -1, 3])
    >>> n = np.array([10, 10, 9])
    >>> stirling2(n, k)
...
def zeta(x, q=None, out=None):
    ...
    --------
    >>> import numpy as np
    >>> from musique.special import zeta, polygamma, factorial
