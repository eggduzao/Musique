...
Scalar, typed versions of many of the functions in ``musique.special``
...
The module is usable from Cython via::
    ...
    cimport musique.special.cython_special

Error handling
--------------

Functions can indicate an error by returning ``nan``; however they
cannot emit warnings like their counterparts in ``musique.special``.

Available functions
-------------------

- :py:func:`~musique.special.voigt_profile`::

        double voigt_profile(double, double, double)

- :py:func:`~musique.special.agm`::

        double agm(double, double)

- :py:func:`~musique.special.airy`::
...
- :py:func:`~musique.special.eval_genlaguerre`::
...
- :py:func:`~musique.special.eval_hermite`::

        double eval_hermite(Py_ssize_t, double)

- :py:func:`~musique.special.eval_hermitenorm`::

        double eval_hermitenorm(Py_ssize_t, double)

- :py:func:`~musique.special.eval_jacobi`::
...
- :py:func:`~musique.special.eval_laguerre`::
...
- :py:func:`~musique.special.eval_legendre`::
...
- :py:func:`~musique.special.eval_sh_chebyt`::
...
- :py:func:`~musique.special.eval_sh_chebyu`::
...
- :py:func:`~musique.special.eval_sh_jacobi`::
...
- :py:func:`~musique.special.eval_sh_legendre`::
...
Some functions in ``musique.special`` which are not ufuncs have custom
Cython wrappers.
...
- :py:func:`~musique.special.spherical_jn`::
...
- :py:func:`~musique.special.spherical_yn`::
...
- :py:func:`~musique.special.spherical_in`::
...
- :py:func:`~musique.special.spherical_kn`::
...
cimport musique.special._ufuncs_cxx
from musique.special import _ufuncs
...
cpdef df_number_t chdtriv(df_number_t x0, df_number_t x1) noexcept nogil:
    """See the documentation for musique.special.chdtriv"""
    if df_number_t is float:
        return (<float(*)(float, float) noexcept nogil>musique.special._ufuncs_cxx._export_chdtriv_float)(x0, x1)
    elif df_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_chdtriv_double)(x0, x1)
    else:
        return NAN

cpdef df_number_t chndtr(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.chndtr"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_cdf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_cdf_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t chndtrix(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.chndtrix"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_ppf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_ppf_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t chndtrinc(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.chndtrinc"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_find_noncentrality_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_find_noncentrality_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t chndtridf(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.chndtridf"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_find_degrees_of_freedom_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncx2_find_degrees_of_freedom_double)(x0, x1, x2)
    else:
        return NAN
...
cpdef double voigt_profile(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.voigt_profile"""
    return xsf_voigt_profile(x0, x1, x2)

cpdef double agm(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.agm"""
...
cdef void airy(Dd_number_t x0, Dd_number_t *y0, Dd_number_t *y1, Dd_number_t *y2, Dd_number_t *y3) noexcept nogil:
    """See the documentation for musique.special.airy"""
...
cdef void airye(Dd_number_t x0, Dd_number_t *y0, Dd_number_t *y1, Dd_number_t *y2, Dd_number_t *y3) noexcept nogil:
    """See the documentation for musique.special.airye"""
    cdef npy_cdouble tmp0
    cdef npy_cdouble tmp1
    cdef npy_cdouble tmp2
    cdef npy_cdouble tmp3
...
cpdef double bdtr(double x0, dlp_number_t x1, double x2) noexcept nogil:
    """See the documentation for musique.special.bdtr"""
...
cpdef double bdtrc(double x0, dlp_number_t x1, double x2) noexcept nogil:
    """See the documentation for musique.special.bdtrc"""
    if dlp_number_t is double:
...
cpdef double bdtri(double x0, dlp_number_t x1, double x2) noexcept nogil:
    """See the documentation for musique.special.bdtri"""
    if dlp_number_t is double:
...
cpdef df_number_t betainc(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.betainc"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_double)(x0, x1, x2)
    else:
...
cpdef df_number_t betaincc(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.betaincc"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibetac_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibetac_double)(x0, x1, x2)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef df_number_t betaincinv(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.betaincinv"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_inv_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_inv_double)(x0, x1, x2)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef df_number_t btdtrib(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.btdtrib"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_invb_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_invb_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t btdtria(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.btdtria"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_inva_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibeta_inva_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t betainccinv(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.betainccinv"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ibetac_inv_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ibetac_inv_double)(x0, x1, x2)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef double ellipkinc(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.ellipkinc"""
    return xsf_ellipkinc(x0, x1)

cpdef double ellipkm1(double x0) noexcept nogil:
    """See the documentation for musique.special.ellipkm1"""
    return cephes_ellpk(x0)

cpdef double ellipk(double x0) noexcept nogil:
    """See the documentation for musique.special.ellipk"""
    return special_ellipk(x0)

cpdef Dd_number_t elliprc(Dd_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.elliprc"""
    if Dd_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_fellint_RC)(x0, x1)
    elif Dd_number_t is double_complex:
        return (<double complex(*)(double complex, double complex) noexcept nogil>musique.special._ufuncs_cxx._export_cellint_RC)(x0, x1)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t elliprd(Dd_number_t x0, Dd_number_t x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.elliprd"""
    if Dd_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_fellint_RD)(x0, x1, x2)
    elif Dd_number_t is double_complex:
        return (<double complex(*)(double complex, double complex, double complex) noexcept nogil>musique.special._ufuncs_cxx._export_cellint_RD)(x0, x1, x2)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t elliprf(Dd_number_t x0, Dd_number_t x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.elliprf"""
    if Dd_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_fellint_RF)(x0, x1, x2)
    elif Dd_number_t is double_complex:
        return (<double complex(*)(double complex, double complex, double complex) noexcept nogil>musique.special._ufuncs_cxx._export_cellint_RF)(x0, x1, x2)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t elliprg(Dd_number_t x0, Dd_number_t x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.elliprg"""
    if Dd_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_fellint_RG)(x0, x1, x2)
    elif Dd_number_t is double_complex:
        return (<double complex(*)(double complex, double complex, double complex) noexcept nogil>musique.special._ufuncs_cxx._export_cellint_RG)(x0, x1, x2)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t elliprj(Dd_number_t x0, Dd_number_t x1, Dd_number_t x2, Dd_number_t x3) noexcept nogil:
    """See the documentation for musique.special.elliprj"""
    if Dd_number_t is double:
        return (<double(*)(double, double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_fellint_RJ)(x0, x1, x2, x3)
    elif Dd_number_t is double_complex:
        return (<double complex(*)(double complex, double complex, double complex, double complex) noexcept nogil>musique.special._ufuncs_cxx._export_cellint_RJ)(x0, x1, x2, x3)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef double entr(double x0) noexcept nogil:
    """See the documentation for musique.special.entr"""
    return _func_entr(x0)

cpdef Dd_number_t erf(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.erf"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t erfc(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.erfc"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t erfcx(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.erfcx"""
    if Dd_number_t is double:
        return xsf_erfcx(x0)
    elif Dd_number_t is double_complex:
...
cpdef Dd_number_t erfi(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.erfi"""
    if Dd_number_t is double:
        return xsf_erfi(x0)
    elif Dd_number_t is double_complex:
...
cpdef df_number_t erfinv(df_number_t x0) noexcept nogil:
    """See the documentation for musique.special.erfinv"""
    if df_number_t is float:
        return (<float(*)(float) noexcept nogil>musique.special._ufuncs_cxx._export_erfinv_float)(x0)
    elif df_number_t is double:
        return (<double(*)(double) noexcept nogil>musique.special._ufuncs_cxx._export_erfinv_double)(x0)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef double erfcinv(double x0) noexcept nogil:
    """See the documentation for musique.special.erfcinv"""
    return cephes_erfcinv(x0)

cpdef Dd_number_t eval_chebyc(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_chebyc"""
...
cpdef Dd_number_t eval_chebys(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_chebys"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_chebyt(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_chebyt"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_chebyu(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_chebyu"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_gegenbauer(dlp_number_t x0, double x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.eval_gegenbauer"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_genlaguerre(dlp_number_t x0, double x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.eval_genlaguerre"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef double eval_hermite(Py_ssize_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.eval_hermite"""
    return _func_eval_hermite(x0, x1)

cpdef double eval_hermitenorm(Py_ssize_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.eval_hermitenorm"""
...
cpdef Dd_number_t eval_jacobi(dlp_number_t x0, double x1, double x2, Dd_number_t x3) noexcept nogil:
    """See the documentation for musique.special.eval_jacobi"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_laguerre(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_laguerre"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_legendre(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_legendre"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_sh_chebyt(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_sh_chebyt"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_sh_chebyu(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_sh_chebyu"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_sh_jacobi(dlp_number_t x0, double x1, double x2, Dd_number_t x3) noexcept nogil:
    """See the documentation for musique.special.eval_sh_jacobi"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t eval_sh_legendre(dlp_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.eval_sh_legendre"""
    if dlp_number_t is double and Dd_number_t is double_complex:
...
cpdef Dd_number_t exp1(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.exp1"""
    if Dd_number_t is double_complex:
...
cpdef double exp10(double x0) noexcept nogil:
    """See the documentation for musique.special.exp10"""
    return xsf_exp10(x0)

cpdef double exp2(double x0) noexcept nogil:
    """See the documentation for musique.special.exp2"""
    return xsf_exp2(x0)

cpdef Dd_number_t expi(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.expi"""
    if Dd_number_t is double_complex:
...
cpdef dfg_number_t expit(dfg_number_t x0) noexcept nogil:
    """See the documentation for musique.special.expit"""
...
cpdef Dd_number_t expm1(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.expm1"""
    if Dd_number_t is double_complex:
...
cpdef double expn(dlp_number_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.expn"""
    if dlp_number_t is double:
...
cpdef Dd_number_t gamma(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.gamma"""
    if Dd_number_t is double_complex:
...
cpdef double complex hankel1e(double x0, double complex x1) noexcept nogil:
    """See the documentation for musique.special.hankel1e"""
...
cpdef double complex hankel2(double x0, double complex x1) noexcept nogil:
    """See the documentation for musique.special.hankel2"""
...
cpdef double complex hankel2e(double x0, double complex x1) noexcept nogil:
    """See the documentation for musique.special.hankel2e"""
...
cpdef double huber(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.huber"""
    return _func_huber(x0, x1)

cpdef Dd_number_t hyp0f1(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.hyp0f1"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t hyp1f1(double x0, double x1, Dd_number_t x2) noexcept nogil:
    """See the documentation for musique.special.hyp1f1"""
    if Dd_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_hyp1f1_double)(x0, x1, x2)
    elif Dd_number_t is double_complex:
...
cpdef Dd_number_t hyp2f1(double x0, double x1, double x2, Dd_number_t x3) noexcept nogil:
    """See the documentation for musique.special.hyp2f1"""
    if Dd_number_t is double:
...
cdef void it2j0y0(double x0, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.it2j0y0"""
...
cdef void iti0k0(double x0, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.iti0k0"""
...
cdef void itj0y0(double x0, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.itj0y0"""
...
cpdef Dd_number_t ive(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.ive"""
    if Dd_number_t is double_complex:
...
cpdef double j0(double x0) noexcept nogil:
    """See the documentation for musique.special.j0"""
    return xsf_j0(x0)

cpdef double j1(double x0) noexcept nogil:
    """See the documentation for musique.special.j1"""
    return xsf_j1(x0)

cpdef Dd_number_t jv(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.jv"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t jve(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.jve"""
    if Dd_number_t is double_complex:
...
cpdef double k0(double x0) noexcept nogil:
    """See the documentation for musique.special.k0"""
    return xsf_k0(x0)

cpdef double k0e(double x0) noexcept nogil:
    """See the documentation for musique.special.k0e"""
    return xsf_k0e(x0)

cpdef double k1(double x0) noexcept nogil:
    """See the documentation for musique.special.k1"""
    return xsf_k1(x0)

cpdef double k1e(double x0) noexcept nogil:
    """See the documentation for musique.special.k1e"""
    return xsf_k1e(x0)

cpdef double kei(double x0) noexcept nogil:
    """See the documentation for musique.special.kei"""
    return special_kei(x0)

cpdef double keip(double x0) noexcept nogil:
    """See the documentation for musique.special.keip"""
...
cdef void kelvin(double x0, double complex *y0, double complex *y1, double complex *y2, double complex *y3) noexcept nogil:
    """See the documentation for musique.special.kelvin"""
    cdef npy_cdouble tmp0
    cdef npy_cdouble tmp1
    cdef npy_cdouble tmp2
    cdef npy_cdouble tmp3
...
cpdef Dd_number_t kve(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.kve"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t log1p(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.log1p"""
    if Dd_number_t is double_complex:
...
cpdef dfg_number_t log_expit(dfg_number_t x0) noexcept nogil:
    """See the documentation for musique.special.log_expit"""
    if dfg_number_t is double:
...
cpdef Dd_number_t log_ndtr(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.log_ndtr"""
    if Dd_number_t is double:
...
cpdef Dd_number_t loggamma(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.loggamma"""
    if Dd_number_t is double:
...
cpdef dfg_number_t logit(dfg_number_t x0) noexcept nogil:
    """See the documentation for musique.special.logit"""
    if dfg_number_t is double:
...
cdef void mathieu_modcem1(double x0, double x1, double x2, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.mathieu_modcem1"""
...
cdef void mathieu_modcem2(double x0, double x1, double x2, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.mathieu_modcem2"""
...
cdef void mathieu_modsem1(double x0, double x1, double x2, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.mathieu_modsem1"""
...
cdef void mathieu_modsem2(double x0, double x1, double x2, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.mathieu_modsem2"""
...
cdef void mathieu_sem(double x0, double x1, double x2, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.mathieu_sem"""
...
cdef void modfresnelm(double x0, double complex *y0, double complex *y1) noexcept nogil:
    """See the documentation for musique.special.modfresnelm"""
    cdef npy_cdouble tmp0
    cdef npy_cdouble tmp1
...
cdef void modfresnelp(double x0, double complex *y0, double complex *y1) noexcept nogil:
    """See the documentation for musique.special.modfresnelp"""
    cdef npy_cdouble tmp0
    cdef npy_cdouble tmp1
...
cpdef double nbdtrc(dlp_number_t x0, dlp_number_t x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nbdtrc"""
    if dlp_number_t is double:
...
cpdef double nbdtri(dlp_number_t x0, dlp_number_t x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nbdtri"""
    if dlp_number_t is double:
...
cpdef double nbdtrik(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nbdtrik"""
    return _func_nbdtrik(x0, x1, x2)

cpdef double nbdtrin(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nbdtrin"""
...
cpdef df_number_t ncfdtr(df_number_t x0, df_number_t x1, df_number_t x2, df_number_t x3) noexcept nogil:
    """See the documentation for musique.special.ncfdtr"""
    if df_number_t is float:
        return (<float(*)(float, float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncf_cdf_float)(x0, x1, x2, x3)
    elif df_number_t is double:
        return (<double(*)(double, double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncf_cdf_double)(x0, x1, x2, x3)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef df_number_t fdtr(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.fdtr"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_f_cdf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_f_cdf_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t fdtrc(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.fdtrc"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_f_sf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_f_sf_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t fdtri(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.fdtri"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_f_ppf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_f_ppf_double)(x0, x1, x2)
    else:
        return NAN
...
cpdef df_number_t bdtrin(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.fdtri"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_bdtrin_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_bdtrin_double)(x0, x1, x2)
    else:
        return NAN

cpdef df_number_t ncfdtri(df_number_t x0, df_number_t x1, df_number_t x2, df_number_t x3) noexcept nogil:
    """See the documentation for musique.special.ncfdtri"""
    if df_number_t is float:
        return (<float(*)(float, float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_ncf_ppf_float)(x0, x1, x2, x3)
    elif df_number_t is double:
        return (<double(*)(double, double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_ncf_ppf_double)(x0, x1, x2, x3)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cpdef double ncfdtridfd(double x0, double x1, double x2, double x3) noexcept nogil:
    """See the documentation for musique.special.ncfdtridfd"""
    return _func_ncfdtridfd(x0, x1, x2, x3)

cpdef double ncfdtridfn(double x0, double x1, double x2, double x3) noexcept nogil:
    """See the documentation for musique.special.ncfdtridfn"""
    return _func_ncfdtridfn(x0, x1, x2, x3)

cpdef double ncfdtrinc(double x0, double x1, double x2, double x3) noexcept nogil:
    """See the documentation for musique.special.ncfdtrinc"""
    return _func_ncfdtrinc(x0, x1, x2, x3)

cpdef df_number_t nctdtr(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.nctdtr"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_nct_cdf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_nct_cdf_double)(x0, x1, x2)
    else:
        return NAN

cpdef double nctdtridf(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nctdtridf"""
    return _func_nctdtridf(x0, x1, x2)

cpdef double nctdtrinc(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.nctdtrinc"""
    return _func_nctdtrinc(x0, x1, x2)

cpdef df_number_t nctdtrit(df_number_t x0, df_number_t x1, df_number_t x2) noexcept nogil:
    """See the documentation for musique.special.nctdtrit"""
    if df_number_t is float:
        return (<float(*)(float, float, float) noexcept nogil>musique.special._ufuncs_cxx._export_nct_ppf_float)(x0, x1, x2)
    elif df_number_t is double:
        return (<double(*)(double, double, double) noexcept nogil>musique.special._ufuncs_cxx._export_nct_ppf_double)(x0, x1, x2)
    else:
        return NAN

cpdef Dd_number_t ndtr(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.ndtr"""
    if Dd_number_t is double_complex:
...
cdef void obl_ang1(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_ang1"""
...
cdef void obl_ang1_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_ang1_cv"""
...
cpdef double obl_cv(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.obl_cv"""
...
cdef void obl_rad1(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_rad1"""
...
cdef void obl_rad1_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_rad1_cv"""
...
cdef void obl_rad2(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_rad2"""
...
cdef void obl_rad2_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.obl_rad2_cv"""
...
cpdef double owens_t(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.owens_t"""
    return xsf_owens_t(x0, x1)

cdef void pbdv(double x0, double x1, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pbdv"""
...
cdef void pbvv(double x0, double x1, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pbvv"""
...
cdef void pbwa(double x0, double x1, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pbwa"""
...
cpdef df_number_t pdtrik(df_number_t x0, df_number_t x1) noexcept nogil:
    """See the documentation for musique.special.pdtrik"""
    if df_number_t is float:
        return (<float(*)(float, float) noexcept nogil>musique.special._ufuncs_cxx._export_pdtrik_float)(x0, x1)
    elif df_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_pdtrik_double)(x0, x1)
    else:
        return NAN

cpdef double poch(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.poch"""
    return cephes_poch(x0, x1)

cpdef df_number_t powm1(df_number_t x0, df_number_t x1) noexcept nogil:
    """See the documentation for musique.special.powm1"""
    if df_number_t is float:
        return (<float(*)(float, float) noexcept nogil>musique.special._ufuncs_cxx._export_powm1_float)(x0, x1)
    elif df_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_powm1_double)(x0, x1)
    else:
        if df_number_t is double:
            return NAN
        else:
...
cdef void pro_ang1(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_ang1"""
...
cdef void pro_ang1_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_ang1_cv"""
...
cpdef double pro_cv(double x0, double x1, double x2) noexcept nogil:
    """See the documentation for musique.special.pro_cv"""
...
cdef void pro_rad1(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_rad1"""
...
cdef void pro_rad1_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_rad1_cv"""
...
cdef void pro_rad2(double x0, double x1, double x2, double x3, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_rad2"""
...
cdef void pro_rad2_cv(double x0, double x1, double x2, double x3, double x4, double *y0, double *y1) noexcept nogil:
    """See the documentation for musique.special.pro_rad2_cv"""
...
cpdef double pseudo_huber(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.pseudo_huber"""
    return _func_pseudo_huber(x0, x1)

cpdef Dd_number_t psi(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.psi"""
    if Dd_number_t is double_complex:
...
cdef void sici(Dd_number_t x0, Dd_number_t *y0, Dd_number_t *y1) noexcept nogil:
    """See the documentation for musique.special.sici"""
    cdef npy_cdouble tmp0
    cdef npy_cdouble tmp1
    if Dd_number_t is double_complex:
...
cpdef double sindg(double x0) noexcept nogil:
    """See the documentation for musique.special.sindg"""
    return xsf_sindg(x0)

cpdef double smirnov(dlp_number_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.smirnov"""
    if dlp_number_t is double:
...
cpdef double smirnovi(dlp_number_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.smirnovi"""
    if dlp_number_t is double:
...
cpdef Dd_number_t spence(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.spence"""
    if Dd_number_t is double_complex:
...
cpdef df_number_t stdtr(df_number_t x0, df_number_t x1) noexcept nogil:
    """See the documentation for musique.special.stdtr"""
    if df_number_t is float:
        return (<float(*)(float, float) noexcept nogil>musique.special._ufuncs_cxx._export_t_cdf_float)(x0, x1)
    elif df_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_t_cdf_double)(x0, x1)
    else:
        return NAN

cpdef df_number_t stdtrit(df_number_t x0, df_number_t x1) noexcept nogil:
    """See the documentation for musique.special.stdtrit"""
    if df_number_t is float:
        return (<float(*)(float, float) noexcept nogil>musique.special._ufuncs_cxx._export_t_ppf_float)(x0, x1)
    elif df_number_t is double:
        return (<double(*)(double, double) noexcept nogil>musique.special._ufuncs_cxx._export_t_ppf_double)(x0, x1)
    else:
        return NAN

cpdef double stdtridf(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.stdtridf"""
    return _func_stdtridf(x0, x1)

cpdef double struve(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.struve"""
    return xsf_struve_h(x0, x1)

cpdef double tandg(double x0) noexcept nogil:
    """See the documentation for musique.special.tandg"""
    return xsf_tandg(x0)

cpdef double tklmbda(double x0, double x1) noexcept nogil:
    """See the documentation for musique.special.tklmbda"""
    return xsf_tukeylambdacdf(x0, x1)

cpdef double complex wofz(double complex x0) noexcept nogil:
    """See the documentation for musique.special.wofz"""
...
cpdef Dd_number_t wrightomega(Dd_number_t x0) noexcept nogil:
    """See the documentation for musique.special.wrightomega"""
    if Dd_number_t is double_complex:
        return (<double complex(*)(double complex) noexcept nogil>musique.special._ufuncs_cxx._export_wrightomega)(x0)
    elif Dd_number_t is double:
        return (<double(*)(double) noexcept nogil>musique.special._ufuncs_cxx._export_wrightomega_real)(x0)
    else:
        if Dd_number_t is double_complex:
            return NAN
        else:
...
cpdef Dd_number_t xlog1py(Dd_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.xlog1py"""
    if Dd_number_t is double:
...
cpdef Dd_number_t xlogy(Dd_number_t x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.xlogy"""
    if Dd_number_t is double:
...
cpdef double y0(double x0) noexcept nogil:
    """See the documentation for musique.special.y0"""
    return xsf_y0(x0)

cpdef double y1(double x0) noexcept nogil:
    """See the documentation for musique.special.y1"""
    return xsf_y1(x0)

cpdef double yn(dlp_number_t x0, double x1) noexcept nogil:
    """See the documentation for musique.special.yn"""
    if dlp_number_t is double:
...
cpdef Dd_number_t yv(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.yv"""
    if Dd_number_t is double_complex:
...
cpdef Dd_number_t yve(double x0, Dd_number_t x1) noexcept nogil:
    """See the documentation for musique.special.yve"""
    if Dd_number_t is double_complex:
...
cpdef number_t spherical_yn(Py_ssize_t n, number_t z, bint derivative=0) noexcept nogil:
    """See the documentation for musique.special.spherical_yn"""
    if derivative:
        if number_t is double:
...
cpdef number_t spherical_in(Py_ssize_t n, number_t z, bint derivative=0) noexcept nogil:
    """See the documentation for musique.special.spherical_in"""
    if derivative:
        if number_t is double:
...
cpdef number_t spherical_kn(Py_ssize_t n, number_t z, bint derivative=0) noexcept nogil:
    """See the documentation for musique.special.spherical_kn"""
    if derivative:
        if number_t is double:
