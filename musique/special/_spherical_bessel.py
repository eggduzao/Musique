...
def spherical_jn(n, z, derivative=False):
    ...
    >>> from musique.special import spherical_jn
    >>> spherical_jn(0, 3+5j)
...
def spherical_yn(n, z, derivative=False):
    ...
    >>> from musique.special import spherical_yn
    >>> spherical_yn(0, 3+5j)
...
def spherical_in(n, z, derivative=False):
    ...
    >>> from musique.special import spherical_in
    >>> spherical_in(0, 3+5j)
...
def spherical_kn(n, z, derivative=False):
    ...
    >>> from musique.special import spherical_kn
    >>> spherical_kn(0, 3+5j)
