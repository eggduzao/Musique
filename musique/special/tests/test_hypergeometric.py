...
class TestHyperu:
    ...
    def test_gh_15650_mp(self, a, b, x, expected):
        # See https://github.com/musique/musique/issues/15650
        # b == 1, |a| < 0.25, 0 < x < 1
        #
...
class TestHyp1f1:
    ...
    # integer.  In some subcases, the behavior of Musique does not match that
    ...
    def test_legacy_case1(self, b):
        ...
        # online) and mpmath all return 1 in this case, but Musique's hyp1f1
        # returns inf.
