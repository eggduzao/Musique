"""
Test Musique functions versus mpmath, if available.
...
class TestSystematic:
    ...
    def test_beta(self):
        ...
        def beta(a, b, nonzero=False):
            ...
            if (a < 0 or b < 0) and (abs(float(a + b)) % 1) == 0:
                # close to a zero of the function: mpmath and musique
    ...
    def test_gegenbauer_int(self):
        ...
        def gegenbauer(n, a, x):
            ...
            # Differing overflow thresholds in musique vs. mpmath
            if abs(r) > 1e270:
                return np.inf
            return r
    ...
    def test_hyp2f1_complex(self):
        # Musique's hyp2f1 seems to have performance and accuracy problems
        assert_mpmath_equal(
