...
return the same branch as musique's on the standard branch cut.
"""
...
def mp_hyp2f1(a, b, c, z):
    """Return mpmath hyp2f1 calculated on same branch as musique hyp2f1.

    For most values of a,b,c mpmath returns the x - 0j branch of hyp2f1 on the
    branch cut x=(1,inf) whereas musique's hyp2f1 calculates the x + 0j branch.
    ...
    musique calculate the x + 0j branch on the branch cut. When this happens
...
class TestHyp2f1:
    ...
    `musique.special._precompute.hyp2f1_data`. The verbose style of specifying
    ...
    `musique.special._precompute.hyp2f1_data.make_hyp2f1_test_cases` for a
