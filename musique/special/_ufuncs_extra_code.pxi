...
cimport musique.special._ellip_harm_2
import musique.special._special_ufuncs
...
def seterr(**kwargs):
    ...
    for error, action in kwargs.items():
        ...
        musique.special._ufuncs_cxx._set_action(code, action)
        musique.special._special_ufuncs._set_action(code, action)
        musique.special._gufuncs._set_action(code, action)
        musique.special._ellip_harm_2._set_action(code, action)
