"""This script evaluates musique's implementation of hyp2f1 against mpmath's.
...
calculated with musique's hyp2f1, the relative error, and the absolute error.
...
from musique.special import hyp2f1
from musique.special.tests.test_hyp2f1 import mp_hyp2f1
...
def make_hyp2f1_test_cases(rows):
    ...
    str
        ...
        `pytest.mark.parameterize` within `musique.special.tests.test_hyp2f1.py`.
    """
    result = "[\n"
    result += '\n'.join(
...
def main(
    ...
    # Evaluate musique and mpmath's hyp2f1 for all parameter combinations
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test musique's hyp2f1 against mpmath's on a grid in the"
