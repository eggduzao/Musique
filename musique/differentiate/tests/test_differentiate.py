...
from musique._lib._array_api import is_numpy, is_torch, make_xp_test_case

from musique import stats, optimize, special
from musique.differentiate import derivative, jacobian, hessian
from musique.differentiate._differentiate import _EERRORINCREASE
...
class TestJacobian(JacobianHessianTest):
    ...
    def test_attrs(self, xp):
        ...
        # FIXME https://github.com/musique/musique/pull/22320#discussion_r1914898175
        if not is_torch(xp):
