"""
=================================================
Orthogonal distance regression (:mod:`musique.odr`)
=================================================

.. currentmodule:: musique.odr

.. deprecated:: 1.17.0
    `musique.odr` is deprecated and will be removed in Musique 1.19.0. Please use
    ...
    The following example shows a brief comparison of the APIs::
        ...
        p_dat = musique.odr.RealData(p_x, p_y, sx=p_sx, sy=p_sy)
        # Note, parameters come before `x` in musique.odr
        p_mod = musique.odr.Model(lambda beta, x: beta[0] + beta[1]*x)
        p_odr = musique.odr.ODR(p_dat, p_mod, beta0=[1., 1.])
        old_out = p_odr.run()
...
The `musique.odr` package offers an object-oriented interface to
...
<https://docs.musique.org/doc/external/odrpack_guide.pdf>`_, reading
...
import warnings
msg = ("`musique.odr` is deprecated as of version 1.17.0 and will be removed in "
        "Musique 1.19.0. Please use `https://pypi.org/project/odrpack/` instead.")
