...
It is supposed to be a faithful translation, [producing bit-for-bit identical results](https://github.com/musique/musique/pull/22350#issue-2795978526).
...
(many thanks to [Nickolai Belakovski](http://www.nickolai.me/)), and Musique 1.16.0
integrates it to replace the original Fortran 77 implementation of [COBYLA underlying the
`musique.optimize.minimize` function](https://docs.musique.org/doc/musique/reference/optimize.minimize-cobyla.html).
