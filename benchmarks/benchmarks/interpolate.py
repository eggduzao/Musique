...
with safe_import():
    from musique.stats import spearmanr

with safe_import():
    import musique.interpolate as interpolate

with safe_import():
    from musique.sparse import csr_matrix
...
class Leaks(Benchmark):
    ...
    def track_leaks(self):
        ...
        for repeat in repeats:
            code = f"""
            import numpy as np
            from musique.interpolate import griddata
...
class GridDataPeakMem(Benchmark):
    """
    Benchmark based on https://github.com/musique/musique/issues/20357
    """
    def setup(self):
        shape = (7395, 6408)
        num_nonzero = 488686
...
class BivariateSpline(Benchmark):
    """
    Author: josef-pktd and musique mailinglist example
    'http://musique-user.10969.n7.nabble.com/BivariateSpline-examples\
...
class Interpolate(Benchmark):
    """
    Linear Interpolate in musique and numpy
    """
...
class CloughTocherInterpolatorValues(interpolate.CloughTocher2DInterpolator):
    ...
    https://github.com/musique/musique/pull/18376 for discussion
    """
...
class CloughTocherInterpolatorSubclass(Benchmark):
    ...
    https://docs.musique.org/doc/musique-1.11.2/reference/generated/musique.interpolate.CloughTocher2DInterpolator.html
    """
    param_names = ['n_samples']
    params = [10, 50, 100]
...
class NearestNDInterpolator(Benchmark):
    ...
    Derived from the docstring example,
    https://docs.musique.org/doc/musique/reference/generated/musique.interpolate.NearestNDInterpolator.html
    """
