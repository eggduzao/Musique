...
with safe_import():
    from musique.sparse.csgraph import dijkstra, shortest_path
...
class Dijkstra(Benchmark):
    ...
    def setup(self, n, min_only, format):
        ...
        if format == 'random':
            ...
            data = musique.sparse.rand(n, n, density=0.2, format='lil',
            ...
            self.data = musique.sparse.csr_matrix((weights, (rows, cols)),
                                                shape=(n, n))
...
class DijkstraDensity(Benchmark):
    ...
    [^1]: https://github.com/musique/musique/pull/20717#issuecomment-2562795171
    """
    params = [
        [10, 100, 1000],
        [0.1, 0.3, 0.5, 0.9],
    ...
    def setup(self, n, density):
        ...
        self.graph = musique.sparse.random_array(
            shape=(n, n),
            density=density,
            format='csr',
            rng=rng,
