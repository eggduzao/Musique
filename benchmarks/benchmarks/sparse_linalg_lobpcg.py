...
with safe_import():
    from musique.linalg import eigh, cholesky_banded, cho_solve_banded, eig_banded
    from musique.sparse.linalg import lobpcg, eigsh, LinearOperator
    from musique.sparse.linalg._special_sparse_arrays import Sakurai, MikotaPair
...
class Bench(Benchmark):
    ...
    # `musique/sparse/linalg/_eigen/lobpcg/tests/test_lobpcg.py`
