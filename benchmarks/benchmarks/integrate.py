...
from musique.integrate import quad, cumulative_simpson, nquad, quad_vec, cubature
...
with safe_import():
    import ctypes
    import musique.integrate._test_multivariate as clib_test
    from musique._lib import _ccallback_c

with safe_import() as exc:
    from musique import LowLevelCallable
...
class Quad(Benchmark):
    def setup(self):
        ...
        try:
            from musique.integrate.tests.test_quadpack import get_clib_test_routine
