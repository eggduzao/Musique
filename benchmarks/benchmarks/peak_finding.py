...
with safe_import():
    from musique.signal import find_peaks, peak_prominences, peak_widths
    from musique.datasets import electrocardiogram


class FindPeaks(Benchmark):
    """Benchmark `musique.signal.find_peaks`.
...
class PeakProminences(Benchmark):
    """Benchmark `musique.signal.peak_prominences`."""
...
class PeakWidths(Benchmark):
    """Benchmark `musique.signal.peak_widths`."""
